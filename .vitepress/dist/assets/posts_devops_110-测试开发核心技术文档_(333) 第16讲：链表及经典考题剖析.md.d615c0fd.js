...
<span class="line"><span style="color:#24292E;">    self.link.travel</span></span></code></pre></div><p>我们来验证下效果，创建一个新的 test_insert 的测试用例，然后在 self.link 中使用 insert，比如我在 3 的位置插入一个 2.5，插完之后我们使用 link.travel 来打印链表。</p>`,13),y=e("p",null,"我们发现插入没有问题，那么 2.5 的位置是多少呢？我们使用 self.link.search 来查找 2.5。",-1),h=e("p",null,"可以发现 2.5 的位置是 3，说明我们已经成功插入了数据，通过这个算法我们可以看到链表的基本使用。链表的核心数据域有两个，data 用来存储数据，next 用来指向下一个节点。",-1),k=e("br",null,null,-1),m=e("p",null,"链表在工作中有很多的用法，比如遍历链表，尾部追加链表，查找关心的数据，以及在特定位置插入数据等。希望你在课后可以自己多加练习并在工作中熟练掌握链表的用法，也能够顺利通过一些大厂的面试。好了，这一课时的内容就结束了，下一课时我将讲解树结构以及关于树结构的经典考题。",-1);function f(g,x,_,u,v,b){const s=t("Image");return i(),o("div",null,[r,n(s,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/61/7B/Cgq2xl4dl6KAZvnXAAEBBAmsoF4690.png"}),a(),d,n(s,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/61/7A/CgpOIF4dl6OATUmnAAFW0-F8eNA749.png"}),a(),E,n(s,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/61/7A/CgpOIF4dl6OAJOdmAAFWyr2vwEM321.png"}),a(),y,n(s,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/61/7B/Cgq2xl4dl6OAH45JAAFROGKvG6M602.png"}),a(),h,k,m])}const A=p(c,[["render",f]]);export{C as __pageData,A as default};
