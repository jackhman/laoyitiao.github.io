import{_ as s,o as n,g as a,Q as l}from"./chunks/framework.a0d18f64.js";const h=JSON.parse('{"title":"第10讲：Python语法知识","description":"","frontmatter":{},"headers":[],"relativePath":"posts/devops/110-测试开发核心技术文档/(326) 第10讲：Python 语法知识.md","filePath":"posts/devops/110-测试开发核心技术文档/(326) 第10讲：Python 语法知识.md","lastUpdated":1696682708000}'),p={name:"posts/devops/110-测试开发核心技术文档/(326) 第10讲：Python 语法知识.md"},e=l(`<h1 id="第10讲-python语法知识" tabindex="-1">第10讲：Python语法知识 <a class="header-anchor" href="#第10讲-python语法知识" aria-label="Permalink to &quot;第10讲：Python语法知识&quot;">​</a></h1><p>本课时我们就主要学习 Python 的基础语法知识，因为本课时的内容非常简单，这里就不再带你演示具体的代码了。</p><h2 id="if-条件判断" tabindex="-1">if 条件判断 <a class="header-anchor" href="#if-条件判断" aria-label="Permalink to &quot;if 条件判断&quot;">​</a></h2><p>首先，我们学习 if 条件判断语句，以具体的场景为例，如代码所示：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">x = input(&quot;你好，请输入你编写自动化测试用例常用的测试框架：&quot;)</span></span>
