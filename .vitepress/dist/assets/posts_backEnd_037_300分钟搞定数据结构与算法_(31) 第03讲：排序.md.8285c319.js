...
<span class="line"><span style="color:#24292E;">        }</span></span>
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h4 id="算法分析-4" tabindex="-1">算法分析 <a class="header-anchor" href="#算法分析-4" aria-label="Permalink to &quot;算法分析&quot;">​</a></h4><h3 id="时间复杂度-4" tabindex="-1">时间复杂度 <a class="header-anchor" href="#时间复杂度-4" aria-label="Permalink to &quot;时间复杂度&quot;">​</a></h3><p>统计顶点的入度需要 O(n) 的时间，接下来每个顶点被遍历一次，同样需要 O(n) 的时间，所以拓扑排序的时间复杂度是 O(n)。</p><p><strong>建议</strong>：利用深度优先搜索的方法对这道题实现拓扑排序。</p><h3 id="结语" tabindex="-1">结语 <a class="header-anchor" href="#结语" aria-label="Permalink to &quot;结语&quot;">​</a></h3><p>这节课复习了面试中经常会被考到的排序算法，最重点内容是归并排序和快速排序。除了要好好理解它们的思路，还必须要能写出没有 bug 的代码，因此建议多做 LeetCode 里面的经典题目。</p><p>下一节课，将深入讲解递归算法和回溯算法，它们在算法面试中出现的概率是最高的。</p>`,12);function g(m,b,_,f,q,k){const s=e("Image");return o(),i("div",null,[c,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/0B/CgoB5l2IiW2AUgXzAEVU1vdS3ek726.gif"}),a(),r,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/0B/CgoB5l2IiW-AJFICAFSirGa8QjY019.gif"}),a(),E,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/0B/CgoB5l2IiXKAR7hcAFhCcVK5jAM221.gif"}),a(),h,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/2B/CgotOV2IiXSAfGJAAF-ZK14qZ9Q978.gif"}),a(),d,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/2B/CgotOV2IiXaAXXBaADUbuSK_xc4506.gif"}),a(),y,n(s,{alt:"",src:"http://s0.lgstatic.com/plat-home-fed/vue/scripts/libraries/UEditor/themes/default/images/spacer.gif"}),a(),n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/2B/CgotOV2IiXqAM6cFAFNa8qMI_JU260.gif"}),a(),u])}const A=p(t,[["render",g]]);export{v as __pageData,A as default};
