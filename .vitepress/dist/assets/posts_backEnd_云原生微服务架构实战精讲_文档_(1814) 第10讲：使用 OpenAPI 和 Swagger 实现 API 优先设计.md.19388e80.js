...
<span class="line"><span style="color:#24292E;">version: 2.1.0</span></span></code></pre></div><h3 id="server-对象" tabindex="-1">Server 对象 <a class="header-anchor" href="#server-对象" aria-label="Permalink to &quot;Server 对象&quot;">​</a></h3><p>Server 对象表示 API 的服务器，下表给出了 Server 对象中可以包含的字段及其说明。</p><br>`,7),u=e(`<br><p>下面代码是 Server 对象的使用示例，其中服务器的 URL 中包含了 port 和 basePath 两个参数，port 是枚举类型，可选值是 80 和 8080。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">url: http://test.myapp.com:{port}/{basePath}</span></span>
