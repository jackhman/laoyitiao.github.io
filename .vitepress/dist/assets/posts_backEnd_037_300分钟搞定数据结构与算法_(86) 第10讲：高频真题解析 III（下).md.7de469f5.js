import{_ as e,j as t,o,h as i,k as l,f as n,s,Q as p}from"./chunks/framework.d3daa342.js";const gs=JSON.parse('{"title":"第10讲：高频真题解析III（下)","description":"","frontmatter":{},"headers":[],"relativePath":"posts/backEnd/037_300分钟搞定数据结构与算法/(86) 第10讲：高频真题解析 III（下).md","filePath":"posts/backEnd/037_300分钟搞定数据结构与算法/(86) 第10讲：高频真题解析 III（下).md","lastUpdated":1696682708000}'),c={name:"posts/backEnd/037_300分钟搞定数据结构与算法/(86) 第10讲：高频真题解析 III（下).md"},r=s("h1",{id:"第10讲-高频真题解析iii-下",tabindex:"-1"},[n("第10讲：高频真题解析III（下) "),s("a",{class:"header-anchor",href:"#第10讲-高频真题解析iii-下","aria-label":'Permalink to "第10讲：高频真题解析III（下)"'},"​")],-1),E=s("h6",{id:"例题分析二",tabindex:"-1"},[n("例题分析二 "),s("a",{class:"header-anchor",href:"#例题分析二","aria-label":'Permalink to "例题分析二"'},"​")],-1),h=s("p",null,"LeetCode 第 84 题：给定 n 个非负整数，用来表示柱状图中各个柱子的高度。每个柱子彼此相邻，且宽度为 1。求在该柱状图中，能够勾勒出来的矩形的最大面积。",-1),y=s("p",null,"说明：下图是柱状图的示例，其中每个柱子的宽度为 1，给定的高度为 [2,1,5,6,2,3]。图中阴影部分为所能勾勒出的最大矩形面积，其面积为 10 个单位。",-1),d=p('<p><strong>示例</strong></p><p>输入: [2,1,5,6,2,3]</p><p>输出: 1</p><h6 id="解题思路一-暴力法" tabindex="-1">解题思路一：暴力法 <a class="header-anchor" href="#解题思路一-暴力法" aria-label="Permalink to &quot;解题思路一：暴力法&quot;">​</a></h6><p>从暴力法开始寻找思路。既然要找出最大的面积，就把所有可能的面积都找出来，然后从中比较出最大的那个。如何找出所有的面积呢？</p><ol><li><p>从左到右扫描一遍输入的数组。</p></li><li><p>遇到每根柱子的时候，以它的高度作为当前矩形的高度。</p></li><li><p>矩形的宽度从当前柱子出发一直延伸到左边和右边。</p></li><li><p>一旦遇到了低于当前高度的柱子就停止。</p></li><li><p>计算面积，统计所有面积里的最大值。</p></li></ol><p>具体的实现步骤如下。</p>',7),_=p('<ol><li><p>第一根柱子高度是 2，当往右边扩展的时候，发现第二根柱子的高度为 1，要低于当前的高度，于是扩展结束，即以第一根柱子高度作为矩形高度，得到矩形面积是 2。</p></li><li><p>第二根柱子，它的高度为 1，以它作为高度的矩形面积是 6。</p></li><li><p>以 5 为高度的矩形面积是 10。</p></li><li><p>以 6 为高度的矩形面积是 6。</p></li><li><p>以 2 为高度的矩形面积是 8。</p></li><li><p>以 3 作为高度的矩形面积为 3。</p></li></ol><br><p>由此，得到最大的面积是 10。</p><p>该算法的时间复杂度是 O(n2)。</p><h6 id="解题思路二-解法优化" tabindex="-1">解题思路二：解法优化 <a class="header-anchor" href="#解题思路二-解法优化" aria-label="Permalink to &quot;解题思路二：解法优化&quot;">​</a></h6><p>以两个柱子的情况为例进行分析。</p><ol><li>不必急于计算以 2 为高度的矩形面积，把 2 暂时保存起来备用，因为一旦从开始就计算矩形面积的话，就是暴力法。</li></ol>',7),g=s("ol",{start:"2"},[s("li",null,"遇到 1 的时候，由于 1 的高度低，造成以 2 为高度的矩形无法延伸到高度为 1 的柱子，即，可以计算高度为 2 的矩形面积。每当遇到一个下降的高度时，就可以开始计算以之前高度作为矩形高度的面积。")],-1),u=s("ol",{start:"3"},[s("li",null,"遇到更高的高度时，也不急计算以 1 为高度的矩形面积，因为 5 的下一个是 6，面积还能继续扩大。")],-1),A=s("ol",{start:"4"},[s("li",null,"再次遇到 2 时，按照之前的策略，可以计算以 6 为高度的矩形面积。")],-1),m=s("ol",{start:"5"},[s("li",null,"是否要计算以 5 作为高度的矩形面积呢？是的，因为 2 比 5 低，以 5 作为高度的矩形无法包含 2 这个点。该宽度如何计算呢？是不是就是 2 的下标减去 5 的下标就可以呢？")],-1),k=s("ol",{start:"6"},[s("li",null,"当计算完高度为 6 的矩形面积时，立即知道下一个高度是 5，以及 5 所对应的下标，可以利用一个 stack 来帮助记录。（注意：此处在整个算法里都很重要。）")],-1),C=s("ol",{start:"7"},[s("li",null,"计算完了以 5 作为高度的矩形面积后，还剩下 1，由于 2 比 1 高，表明后面可能还有更高的点，而以 1 为高度的矩形还能扩展。")],-1),f=s("ol",{start:"8"},[s("li",null,"下一个比 2 还高，于是继续保留它在 stack 里。")],-1),B=s("p",null,"到这里，所有的柱子都遍历完了，如何处理剩下的 3 根柱子呢？",-1),P=s("p",null,"以新的柱子高度为 0，由于 0 低于任何一根柱子的高度，那么对剩下的柱子计算，以它们的高度作为边的矩形的面积。",-1),S=s("ul",null,[s("li",null,[s("p",null,"指针停留在下标为 6 的地方，堆栈里记录的是三根柱子的下标：5，4，1。")]),s("li",null,[s("p",null,"跟之前计算其他柱子的情况一样，先将堆栈里的下标弹出，第一个弹出的是 5。")]),s("li",null,[s("p",null,"然后比它矮的那根柱子的下标一定是堆栈目前顶端的那个，也就是 4。")]),s("li",null,[s("p",null,"因此以 3 作为高度的矩形的宽度就是：i - 1 - 4 = 6 - 1 - 4 = 1，那么面积就是 3 x 1 = 3。")])],-1),I=s("p",null,"剩下的 2 根柱子，方法同样，目前 stack 里的值是：4，1。",-1),b=s("p",null,"把下标 4 弹出，得知比这根柱子还要矮的柱子的下标一定是 stack 顶端的值，也就是 1。",-1),q=s("p",null,"那么以高度 2 作为矩形高度的矩形宽度就是：i - 1 - 1 = 6 - 1 - 1 = 4，面积就是 2 x 4 = 8。",-1),D=s("p",null,"最后处理剩下 1 的柱子。",-1),T=p(`<p>将它弹出，发现此时堆栈为空。那以 1 作为高度的矩形的宽度是多少呢？很简单，就是 i，也就是 6。因为它一定是最矮的那个才会留到最后，那么它的宽度就应该是横跨整个区间。所以求得面积就是 6。</p><h3 id="代码实现" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现" aria-label="Permalink to &quot;代码实现&quot;">​</a></h3><ol><li><p>一旦我们发现当前的高度要比堆栈顶端所记录的高度要矮，就可以开始对堆栈顶端记录的高度计算面积了。在这里，我们巧妙地处理了当 i 等于 n 时的情况。同时在这一步里，我们判断一下当前的面积是不是最大值。</p></li><li><p>如果当前的高度比堆栈顶端所记录的高度要高，就压入堆栈。</p></li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">// 将输入数组的长度记为 n，初始化最大面积 max 为 0</span></span>
...
<span class="line"><span style="color:#24292E;">  </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h3 id="复杂度分析-3" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析-3" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h3><p>时间复杂度为 O(n) ，这是一种比较高效的做法。</p><h3 id="举例说明" tabindex="-1">举例说明 <a class="header-anchor" href="#举例说明" aria-label="Permalink to &quot;举例说明&quot;">​</a></h3><p>下面通过举例来加深印象。</p><p>例题：needle 是 ADCADBADCADC。</p>`,8),H=s("ol",null,[s("li",null,"一开始，初始化 LPS 数组全部为 0。")],-1),U=s("p",null,"规定前缀和后缀不能是同一个字符串，所以从第二个字符开始扫描，此时 len = 0，i = 1。AD 字符串的最长公共前缀和后缀为 0，因为 A 不等于 D，所以 LPS[1] = 0。",-1),X=s("ol",{start:"2"},[s("li",null,"移动到 C。同样，对于 ADC ，最长的公共前缀和后缀也是 0，所以 LPS[2] = 0，此时，len 变量一直是 0。")],-1),z=s("ol",{start:"3"},[s("li",null,"移动到 A，此时 i=3。")],-1),$=s("p",null,"对于字符串 ADCA，因为 needle[len] = needle[3]，所以执行代码 lps[i++] = ++len，也就是把 len+1 赋给 lps[i]，然后 i + 1，len + 1，表明对于字符串 ADCA，最长的公共前缀和后缀的长度为 1。",-1),ss=s("ol",{start:"4"},[s("li",null,"接下来到 D，此时 i = 4，len = 1。")],-1),ns=s("p",null,"同样，由于 needle[len] 等于 needle[i]，都是字符 D，所以再次执行代码 lps[i++] = ++len，这样一来，lps[4] 就等于 2，表明对于字符串 ADCAD，最长的公共前缀和后缀长度是 2。",-1),as=s("ol",{start:"5"},[s("li",null,"接下来是 B，此时 i = 5，len = 2。")],-1),ls=s("p",null,"needle[len] ='C'，而 needle[i] ='B'，两者不相等，同时，len 大于 0，将 len 修改为 lps[len - 1]，取出字符串 AD 的最长公共前缀和后缀的长度，也就是 0。当循环再次进行，needle[len] 仍不等于 neele[i]，因此对于 ADCADB ，最长的公共前缀后缀长度为 0。",-1),ps=s("p",null,[s("strong",null,"建议"),n("：以上基本概括了 KMP 的算法思想和精髓，其实 KMP 的代码实现是很精妙的，建议大家不要去死记硬背，通过理解去帮助记忆。")],-1),es=s("h6",{id:"结语",tabindex:"-1"},[n("结语 "),s("a",{class:"header-anchor",href:"#结语","aria-label":'Permalink to "结语"'},"​")],-1),ts=s("p",null,"这节课讲解了三道比较难的题目，其中正规表达式以及 KMP 算法是重中之重。",-1),os=s("br",null,null,-1);function is(cs,rs,Es,hs,ys,ds){const a=t("Image");return o(),i("div",null,[r,E,h,y,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaBmANhiBAAAvRVLSdAM365.png"}),n(),d,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaBqAT7fLAHGVT_G-HGE157.gif"}),n(),_,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaBqAXPBJAA5Vx5kRvrI712.gif"}),n(),g,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaBuAQ_G7AB8iyyFhsP8537.gif"}),n(),u,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaBuAanh5ABOPEuDQKbE900.gif"}),n(),A,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaByAHgaZABWZDxwJlTo840.gif"}),n(),m,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaByAQjMCAByIrvLjjAM248.gif"}),n(),k,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaByAfZyzAABI-qF4lwQ735.png"}),n(),C,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB2ACxD_AC1iHvcGTv8971.gif"}),n(),f,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaB2AS6txACaMXIPm9-I299.gif"}),n(),B,P,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB6AZDoqAB3_QEbtXrY350.gif"}),n(),S,I,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaB6AWUQNACIE9DZQPyI414.gif"}),n(),b,q,D,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB6AMiybAByyazYRVgg510.gif"}),n(),T,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB-AZrqFAIWMuevJfbs428.gif"}),n(),M,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCCAEy-TABNB_IdI3Eg442.gif"}),n(),x,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCCAJ39aAERYoGxb1p0088.gif"}),n(),j,L,V,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCGAZUF4AAAhUwmoEAc094.png"}),n(),v,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCGAJrCpAAAk60Qcsyw360.png"}),n(),O,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCGACDXcAB5wm3NTrb4729.gif"}),n(),w,N,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCKAeEE4AI6KeO453eY927.gif"}),n(),K,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCOAJzQ0ACMA3QOrN2A725.gif"}),n(),Q,F,R,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCOAcfWEAHw9WU7AYQY830.gif"}),n(),G,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCSATVZPACdhTz792dg446.gif"}),n(),J,Y,W,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCSAVpIQAFEf-VyP6-A314.gif"}),n(),Z,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCWAYemSAGbI_2HuWFE739.gif"}),n(),H,U,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCaATxS8ABYXnYXhN1Y816.gif"}),n(),X,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCaAEnHyACFGv5D5WL4879.gif"}),n(),z,$,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCaAPe83ACKGclsUKCA865.gif"}),n(),ss,ns,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCeAW6P4AEhZHBJ_UJQ849.gif"}),n(),as,ls,ps,es,ts,os])}const us=e(c,[["render",is]]);export{gs as __pageData,us as default};
