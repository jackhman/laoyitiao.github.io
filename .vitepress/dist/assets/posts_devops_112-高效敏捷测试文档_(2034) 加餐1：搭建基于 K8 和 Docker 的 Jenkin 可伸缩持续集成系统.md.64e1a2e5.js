import{_ as l,D as o,o as t,g as c,J as e,h as n,Q as p,m as s}from"./chunks/framework.f67d7268.js";const W=JSON.parse('{"title":"加餐1：搭建基于K8和Docker的Jenkin可伸缩持续集成系统","description":"","frontmatter":{},"headers":[],"relativePath":"posts/devops/112-高效敏捷测试文档/(2034) 加餐1：搭建基于 K8 和 Docker 的 Jenkin 可伸缩持续集成系统.md","filePath":"posts/devops/112-高效敏捷测试文档/(2034) 加餐1：搭建基于 K8 和 Docker 的 Jenkin 可伸缩持续集成系统.md","lastUpdated":1696682708000}'),r={name:"posts/devops/112-高效敏捷测试文档/(2034) 加餐1：搭建基于 K8 和 Docker 的 Jenkin 可伸缩持续集成系统.md"},i=p('<h1 id="加餐1-搭建基于k8和docker的jenkin可伸缩持续集成系统" tabindex="-1">加餐1：搭建基于K8和Docker的Jenkin可伸缩持续集成系统 <a class="header-anchor" href="#加餐1-搭建基于k8和docker的jenkin可伸缩持续集成系统" aria-label="Permalink to &quot;加餐1：搭建基于K8和Docker的Jenkin可伸缩持续集成系统&quot;">​</a></h1><p>根据前面用户的反馈，这里补充一个完整的动手实践的案例------搭建&quot;基于 K8s 和 Docker 的 Jenkins 可伸缩持续集成系统&quot;，让模块 3 所介绍的内容落地。</p><br><p>这部分内容比较多且非常具体，包括 4 大部分：</p><ul><li><p>Kubernetes （K8s）集群的部署，包括 kube-proxy、kubelet、docker 和 flanneld services 等安装；</p></li><li><p>企业级容器注册管理平台 Harbor 的安装部署，包括 Docker、Docker Compose 等安装；</p></li><li><p>采用 Jenkins pipeline 实现自动构建并部署至 K8s，包括建立 spring boot 示例工程、创建 Dockerfile 和 Jenkinsfile、配置 jenkins pipeline 任务和 K8s 的 kube.config 到最后测试 pipeline 任务等；</p></li><li><p>遇到的问题（坑）及解决方法，比如启动 Jenkins，安装插件出现&quot;无法连接服务器&quot;错误，运行 pipeline，出现 command not found 错误等几个问题的解决。</p></li></ul><br><p>这些具体的操作步骤经过了真实环境上的检验，最终整个基于 K8s 、Docker、Jenkins 的 CI 系统被成功部署起来。建议你按照下面介绍的详细步骤，自己亲自动手操作一回，功力会大增。</p><h1 id="工作流程图" tabindex="-1">工作流程图 <a class="header-anchor" href="#工作流程图" aria-label="Permalink to &quot;工作流程图&quot;">​</a></h1>',8),E=p(`<h1 id="系统配置" tabindex="-1"><strong>系统配置</strong> <a class="header-anchor" href="#系统配置" aria-label="Permalink to &quot;**系统配置**&quot;">​</a></h1><p>Harbor 仓库 CentOS7、4 核 CPU、16G 内存、160G 硬盘</p><ul><li>192.168.10.160 harbor</li></ul><p>集群 3 台机器，CentOS7、4 核 CPU、16G 内存、60G 硬盘</p><ul><li><p>192.168.10.161 k8s-master</p></li><li><p>192.168.10.162 k8s-node1</p></li><li><p>192.168.10.163 k8s-node2</p></li></ul><h1 id="kubernetes-集群部署" tabindex="-1"><strong>Kubernetes 集群部署</strong> <a class="header-anchor" href="#kubernetes-集群部署" aria-label="Permalink to &quot;**Kubernetes 集群部署**&quot;">​</a></h1><h2 id="安装前准备" tabindex="-1"><strong>安装前准备</strong> <a class="header-anchor" href="#安装前准备" aria-label="Permalink to &quot;**安装前准备**&quot;">​</a></h2><p>（1）关闭 firewalld 改用 iptables。输入以下命令，关闭 firewalld：</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[root@master ~]# systemctl stop firewalld.service #停止firewall </span></span>
...
<span class="line"><span style="color:#24292E;">server.port=40080</span></span></code></pre></div><br><p>（3）编译运行，访问 <a href="https://links.jianshu.com/go?to=http%3A%2F%2Flocalhost%3A40080" target="_blank" rel="noreferrer">http://localhost:40080</a> 地址可以看到示例运行结果。</p><br>`,18),m=p(`<h3 id="添加-dockerfile" tabindex="-1">添加 Dockerfile <a class="header-anchor" href="#添加-dockerfile" aria-label="Permalink to &quot;添加 Dockerfile&quot;">​</a></h3><p>在工程根目录创建 Dockerfile，用来构建 docker 镜像，其中 \${JAR_FILE} 参数在 pipeline 执行 docker build 时，通过 build-arg 参数传入。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">FROM openjdk:8-jdk-alpine</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;"> ln -s docker-runc-current docker-runc</span></span></code></pre></div>`,28);function w(U,L,B,$,H,J){const a=o("Image");return t(),c("div",null,[i,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/02/56/CgoCgV6VqwKAajirAAOot2kHSIM714.jpg"}),n(),E,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/88/9A/Cgq2xl6VqwOAQO5oAAFotppxiS8332.png"}),n(),d,u,y,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/0F/84/Ciqah16VqwOAIEKcAABK8b1J5Pk588.png"}),n(),h,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/02/56/CgoCgV6VqwOAJy7rAADUBv3omAM239.png"}),n(),g,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/88/9A/Cgq2xl6VqwSAb3T1AACLTw_peWM870.png"}),n(),k,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/88/9A/Cgq2xl6VqwSAQcWQAAIi7I6BGhU522.png"}),n(),b,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/02/56/CgoCgV6VqwSAJIY2AAAIQDo_SXo223.png"}),n(),m,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/88/9A/Cgq2xl6VqwWAZFSOAAHcXpy5dUQ145.png"}),n(),_,v,A,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/0F/84/Ciqah16VqwWAHp5dAAEiQclu3N0609.png"}),n(),q,C,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/02/56/CgoCgV6VqwWAPUy5AAGuJhe8aC0834.png"}),n(),T,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/88/9A/Cgq2xl6VqwaAOCwNAADQwtyky3E891.png"}),n(),S,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/0F/84/Ciqah16VqwaAagi2AADuteUwitQ741.png"}),n(),R,f,P,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/02/56/CgoCgV6VqweAUtIeAAGPNqdcCX8865.png"}),n(),I,D,N,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/88/9A/Cgq2xl6VqweAQ7a8AAIM89lGIAQ017.png"}),n(),x,j,O,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/0F/84/Ciqah16VqweADadcAAEwylSrC84442.png"}),n(),K,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/02/56/CgoCgV6VqwiATbn1AABaEnvkQGA790.png"}),n(),V,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/88/9A/Cgq2xl6VqwiAfRQ1AAB6C4ZT3sw648.png"}),n(),G,e(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/0F/84/Ciqah16VqwmAYg73AADiqrgm5wY712.png"}),n(),M])}const Q=l(r,[["render",w]]);export{W as __pageData,Q as default};
