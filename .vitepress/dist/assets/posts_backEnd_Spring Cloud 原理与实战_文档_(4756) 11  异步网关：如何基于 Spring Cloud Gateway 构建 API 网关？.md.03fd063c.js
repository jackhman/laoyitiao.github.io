import{_ as n,j as l,o as p,g as e,k as o,h as t,Q as s}from"./chunks/framework.e0c66c3f.js";const C=JSON.parse('{"title":"Spring Cloud Gateway 简介 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/backEnd/Spring Cloud 原理与实战_文档/(4756) 11  异步网关：如何基于 Spring Cloud Gateway 构建 API 网关？.md","filePath":"posts/backEnd/Spring Cloud 原理与实战_文档/(4756) 11  异步网关：如何基于 Spring Cloud Gateway 构建 API 网关？.md","lastUpdated":1696338709000}'),r={name:"posts/backEnd/Spring Cloud 原理与实战_文档/(4756) 11  异步网关：如何基于 Spring Cloud Gateway 构建 API 网关？.md"},c=s(`<p>我们知道在微服务架构中，可以根据需要在服务提供者和消费者之间架设 API 网关，来满足需要服务路由和控制的各种场景。在前面两个课时中，我们分析了 Zuul 网关的使用方式和实现原理。今天我们继续介绍另一款 API 网关，即 Spring Cloud Gateway。</p><h3 id="spring-cloud-gateway-简介" tabindex="-1">Spring Cloud Gateway 简介 <a class="header-anchor" href="#spring-cloud-gateway-简介" aria-label="Permalink to &quot;Spring Cloud Gateway 简介&quot;">​</a></h3><p>Spring Cloud Gateway 是 Spring 官方自己开发的一款 API 网关。在具体展开介绍 Spring Cloud Gateway 之前，我们有必要对它和 Netflix Zuul 做一个对比。通过上一课时的分析，我们知道 Zuul 的实现原理是对 Servlet 的一层封装，通信模式上采用的是阻塞式 I/O。而在技术体系上，Spring Cloud Gateway 基于最新的 Spring 5 和 Spring Boot 2，以及用于响应式编程的 Project Reactor 框架，提供的是响应式、非阻塞式 I/O 模型。所以较之 Netflix Zuul，<strong>性能上</strong>Spring Cloud Gateway 显然要更胜一筹。</p><p>另一方面，<strong>从功能上</strong>，Spring Cloud Gateway 也比 Zuul 更为丰富。除了通用的服务路由机制之外，Spring Cloud Gateway 还支持请求限流等面向服务容错方面的功能，同样也能与 Hystrix 等框架进行良好的集成。</p><p>讲到这里，你可能会觉得既然有了性能和功能都更高一筹的 Spring Cloud Gateway，那我们为什么还要介绍 Zuul 呢？这是因为 Spring Cloud Gateway 的源码非常复杂，出现问题不容易排查和解决。而 Zuul 的编程模型和底层原理都非常简单，开发调试上也容易把握。</p><p>要想在微服务架构中引入 Spring Cloud Gateway，我们同样需要构建一个独立的 Spring Boot 应用程序，并在 Maven 中添加如下依赖项：</p><div class="language-xml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">xml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">dependency</span><span style="color:#E1E4E8;">&gt;</span></span>
