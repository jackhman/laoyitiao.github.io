...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h6 id="复杂度分析" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h6><p>利用 Trie，在创建和查找的过程中，最多会遇到 n×k 个节点，而且会进行回文检查，所以整体的时间复杂度是：O(n×k×k)。</p><p>如果字符串的字符个数是在一定范围之内的，那么这个问题就可以优化成一个近乎于线性问题了。</p><h6 id="例题分析二" tabindex="-1">例题分析二 <a class="header-anchor" href="#例题分析二" aria-label="Permalink to &quot;例题分析二&quot;">​</a></h6><p>LeetCode 第 340 题：给定一个字符串 s ，找出至多包含 k 个不同字符的最长子串 T。</p><p><strong>示例 1</strong></p><p>输入: s = &quot;eceba&quot;, k = 2</p><p>输出: 3</p><p>解释: 则 T 为 &quot;ece&quot;，所以长度为 3。</p><p><strong>示例 2</strong></p><p>输入: s = &quot;aa&quot;, k = 1</p><p>输出: 2</p><p>解释: 则 T 为 &quot;aa&quot;，所以长度为 2。</p><h6 id="解题思路-暴力法-1" tabindex="-1">解题思路：暴力法 <a class="header-anchor" href="#解题思路-暴力法-1" aria-label="Permalink to &quot;解题思路：暴力法&quot;">​</a></h6><p>思路：找出所有的子串，然后逐一检查是否最多包含 k 个不同的字符。</p><br><p>实现：用一个哈希表或者哈希集合去统计。</p><br><p>复杂度：O(n^2)。</p><p>第 8 课讲解了一道 LeetCode 的题目，给定一个字符串，找出无重复字符的最长子串。当时提出了一种比较聪明的办法，能够在 O(n) 的时间里找到答案。上述例题其实是它的另外一种扩展，可以运用相似的策略来进行。</p><p>举例：s = &quot;eceba&quot;，k = 2。</p><p>实现过程如下。</p>`,42),v=s("p",null,"用两个快慢指针：i 和 j，i 是慢指针，j 是快指针。一开始，两个指针都指向字符串的开头。另外，还需要一个哈希表来统计每个字符出现的个数，同时用来统计不同字符的个数。",-1),x=s("ol",null,[s("li",null,"每次将快指针指向的字符添加到哈希表中，统计它出现的次数。第一个字符是 e，加入到 map 中。")],-1),j=s("ol",{start:"2"},[s("li",null,"map 的大小为 1，表明到目前为止出现了一个字符。由于 map 的大小还没有超过 k，快指针向前移动一步。")],-1),I=s("ol",{start:"3"},[s("li",null,"j 指向的字符是 c，同样统计到 map 中，此时 map 的大小为 2，也没有超过 k，快指针继续移动。")],-1),D=s("ol",{start:"4"},[s("li",null,"当前 j 指向的字符是 e，现在 e 出现了 2 次，但是 map 的大小还是 2，表明到目前为止只看到两个不同的字符，即 e 和 c。")],-1),F=s("ol",{start:"5"},[s("li",null,"继续移动 j 指针，出现了新的字符 b，加入到 map 中。")],-1),P=s("ol",{start:"6"},[s("li",null,"此时 map 的大小为 3，已经超过了 2，于是慢指针开始删除字符，目的是为了控制住 map 的大小不超过 2。")],-1),S=s("ol",{start:"7"},[s("li",null,"当把第一个字符删除的时候，在 map 里更新 e 字符的计数，但是整个 map 的大小还是等于 3，继续相同的操作。")],-1),M=s("ol",{start:"8"},[s("li",null,"c 的个数只有一个，直接把它从 map 里删除掉。现在 map 的大小恢复正常，继续移动快指针。")],-1),V=p(`<ol start="9"><li><p>当把 a 添加到 map 里后，map 的大小又超过了 2，于是移动慢指针，把它指向的字符从 map 中删除掉。</p></li><li><p>结束循环。</p></li></ol><h6 id="代码实现-1" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现-1" aria-label="Permalink to &quot;代码实现&quot;">​</a></h6><ul><li><p>初始化一个哈希表 map，用来统计所出现了的不同字符。</p></li><li><p>用 max 变量记录最长的子串，其中子串最多包含 k 个不同的字符。</p></li><li><p>用快慢指针遍历字符串。</p></li><li><p>将快指针指向的字符加入到 map 中，统计字符出现的次数。</p></li><li><p>如果发现 map 的大小超过了 k，那么就得开始不断地将慢指针所指向的字符从 map 里清除掉。</p></li><li><p>首先获取当前慢指针指向的字符。</p></li><li><p>将它在map中的计数减一。</p></li><li><p>一旦它的统计次数变成了 0，就可以把它从 map 中删掉了。</p></li><li><p>接下来，慢指针继续往前走。</p></li><li><p>当 map 的大小恢复正常了，统计一下当前子串的长度。</p></li><li><p>最后返回最大的子串长度。</p></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">int lengthOfLongestSubstringKDistinct(String s, int k) {</span></span>
...
<span class="line"><span style="color:#24292E;">  </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h6 id="复杂度分析-2" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析-2" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h6><p>假设一共有 m 行 n 列，那么一共有 m×n 个方块。对于每个方块，都有可能会进行优先队列的操作，而优先队列的大小为 m + n，加上初始化优先队列的操作时间，因此，整体的时间复杂度为 O(m + n) + O(m×n×log(m + n)) = O(m×n×log(m + n))。</p><p>由上可知，将复杂度下降了一个维度。</p><p>建议：对于这种在 BFS 中运用&quot;农村包围城市&quot;的策略，LeetCode 上还有一道题，第 417 题，太平洋大西洋水流问题，建议大家课后去试试。</p><h6 id="结语" tabindex="-1">结语 <a class="header-anchor" href="#结语" aria-label="Permalink to &quot;结语&quot;">​</a></h6><p>这节课讲了三道比较难想的题目，至此已经把所有关于数据结构、算法、以及相关的题目做了讲解，掌握好我们课上讲过的知识点，一定会对你的面试准备有很大的帮助。</p><p>当然，要能在面试中取得理想的发挥，还是要看平时的练习是否足够，不光在数量上，更要在质量上严格要求自己。</p><p>下节课将会分享一些面试准备中的方法和技巧。</p><br>`,18);function ss(ns,as,ls,ps,es,os){const a=o("Image");return t(),i("div",null,[r,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q2AHWZiAAA5qCvSGLk571.png"}),n(),E,y,d,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4Q2ATkxxAABJBdsgXhA725.png"}),n(),h,u,g,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q2AEHAWAABJfYeVV4k708.png"}),n(),m,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4Q2AHbOfAABrqvMxUVU130.png"}),n(),_,b,f,A,q,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q2AGNocAABw4HvSobY774.png"}),n(),k,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q-AFUARAFdBFfNwj4s416.gif"}),n(),w,T,C,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RGAdPAxAGKOo26J4J8733.gif"}),n(),B,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RGActCuAACWTDVjmS4562.png"}),n(),v,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RGAIz3YAACUEV4BZ10058.png"}),n(),x,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RKAYjhXAA248QeqTy0883.gif"}),n(),j,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RKAB20KAA0Y_xJpZGc219.gif"}),n(),I,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RKAQZMoAACUJa2fTUI207.png"}),n(),D,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4ROAXs2mABP3Qvxxwgc796.gif"}),n(),F,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4ROABmg9ACHl6sZ0cUE027.gif"}),n(),P,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RSAS2V0AAwyhXeaga4800.gif"}),n(),S,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RSAP5kkABVxWpINXZU330.gif"}),n(),M,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RWAEvZNAB6BcQzB1BA923.gif"}),n(),V,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4ReAeHXlAIqi3-dedKM816.gif"}),n(),N,O,L,R,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4ReAKOakAABLZGpg3no849.png"}),n(),H,Q,K,W,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RiAE6xSAABpFZMq9Kc568.png"}),n(),U,Z,G,J,X,Y,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RiAR15vAACREQ7D-94461.png"}),n(),z,l(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RmAE6UaADwhl85qEAo165.gif"}),n(),$])}const cs=e(c,[["render",ss]]);export{is as __pageData,cs as default};
