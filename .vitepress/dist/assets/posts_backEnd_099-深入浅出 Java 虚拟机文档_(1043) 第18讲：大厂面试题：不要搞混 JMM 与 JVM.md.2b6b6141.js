...
<span class="line"><span style="color:#24292E;">load2</span></span></code></pre></div><br><h2 id="小结" tabindex="-1">小结 <a class="header-anchor" href="#小结" aria-label="Permalink to &quot;小结&quot;">​</a></h2><p>好了，到这里我们已经简要地介绍完了 JMM 相关的知识点。前面提到过，&quot;请谈一下 Java 的内存模型&quot;这个面试题非常容易被误解，甚至很多面试官自己也不清楚这个概念。其实，如果我们把 JMM 叫作&quot;Java 的并发内存模型&quot;，会更容易理解。</p><br><p>这个时候，可以和面试官确认一下，问的是 Java 内存布局，还是和多线程相关的 JMM，如果不是 JMM，你就需要回答一下第 02 课时的相关知识了。</p><br><p>JMM 可以说是 Java 并发的基础，它的定义将直接影响多线程实现的机制，如果你想要深入了解多线程并发中的相关问题现象，对 JMM 的深入研究是必不可少的。</p><br><p><a href="https://www.infoq.cn/article/java-memory-model-1" target="_blank" rel="noreferrer">想要深入了解这方面知识的，请点击这里</a>。</p>`,74);function b(y,_,u,v,m,M){const a=l("Image");return e(),o("div",null,[c,n(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/72/A7/CgpOIF5onG-ASh8rAABuZux4V8o900.jpg"}),i,n(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/72/AA/CgpOIF5on1aAHrXyAAErA3GeoZc492.png"}),d,n(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/72/A7/CgpOIF5onHCAZexGAAB54PXjqm0171.jpg"}),E,n(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/72/A7/Cgq2xl5onHCAAcYVAACpkPY4wyE593.png"}),g,n(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/72/A7/CgpOIF5onHCAXFzbAADGGN8aPCY990.png"}),t(),h])}const k=p(r,[["render",b]]);export{A as __pageData,k as default};
