import{_ as s,o as n,g as a,Q as l}from"./chunks/framework.e0c66c3f.js";const f=JSON.parse('{"title":"if 条件判断 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/devops/110-测试开发核心技术文档/(326) 第10讲：Python 语法知识.md","filePath":"posts/devops/110-测试开发核心技术文档/(326) 第10讲：Python 语法知识.md","lastUpdated":1696338709000}'),p={name:"posts/devops/110-测试开发核心技术文档/(326) 第10讲：Python 语法知识.md"},e=l(`<p>本课时我们就主要学习 Python 的基础语法知识，因为本课时的内容非常简单，这里就不再带你演示具体的代码了。</p><h2 id="if-条件判断" tabindex="-1">if 条件判断 <a class="header-anchor" href="#if-条件判断" aria-label="Permalink to &quot;if 条件判断&quot;">​</a></h2><p>首先，我们学习 if 条件判断语句，以具体的场景为例，如代码所示：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">x = input(&quot;你好，请输入你编写自动化测试用例常用的测试框架：&quot;)</span></span>
...
<span class="line"><span style="color:#24292E;">x.f()</span></span></code></pre></div><p>在类里面涉及几个关键的知识点：</p><ul><li><p>第一个是类的定义，通过 class + 类名 的方式即可定义一个类；</p></li><li><p>然后是初始化方法，初始化方法使用 <strong>init</strong> 即可；</p></li><li><p>第三个是类变量，定义在类里的变量即为类变量，比如 i = 12345；</p></li><li><p>k可以使用 @ class 的方式将方法升级为类方法；</p></li><li><p>当调用方法时传入的参数是 self 就表示该方法为实例方法。</p></li></ul><p>到这里本课时的内容就结束了，通过本课时的学习你可以掌握 Python 常见的控制语句，以及函数与类的相关知识，希望你在课后针对这方面的内容勤加练习，如果你想要更深入地研究还可以查看 Python 的使用文档。</p>`,34),o=[e];function t(i,c,r,E,y,u){return n(),a("div",null,o)}const h=s(p,[["render",t]]);export{f as __pageData,h as default};
