import{_ as s,o as n,g as a,Q as p}from"./chunks/framework.f949202b.js";const u=JSON.parse('{"title":"判断动态规划 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/backEnd/037_300分钟搞定数据结构与算法/(34) 第06讲：动态规划.md","filePath":"posts/backEnd/037_300分钟搞定数据结构与算法/(34) 第06讲：动态规划.md","lastUpdated":null}'),l={name:"posts/backEnd/037_300分钟搞定数据结构与算法/(34) 第06讲：动态规划.md"},e=p(`<p>动态规划可以说是很多准备算法面试者的梦魇，大家都非常怕面试官会出动态规划的题目，如果遇到一些做过的题目还好，但要是遇到了根本就没有做过的，就无从下手了。</p><p>本节课从动态规划的基本属性，题目分类，解题思想，以及算法复杂度等方面来详解动态规划。</p><h6 id="判断动态规划" tabindex="-1">判断动态规划 <a class="header-anchor" href="#判断动态规划" aria-label="Permalink to &quot;判断动态规划&quot;">​</a></h6><p>Wikipedia 定义：它既是一种数学优化的方法，同时也是编程的方法。</p><ol><li>是数学优化的方法------最优子结构</li></ol><br><p>动态规划是数学优化的方法指，动态规划要解决的都是问题的最优解。而一个问题的最优解是由它的各个子问题的最优解决定的。</p><br><p>由此引出动态规划的第一个重要的属性：最优子结构（Optimal Substructure)。</p><br><p>一般由最优子结构，推导出一个状态转移方程 f(n)，就能很快写出问题的递归实现方法。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/90/EF/CgoB5l2IcqKAT-iFAAvZ0mB2w9o185.gif" alt=""></p><ol start="2"><li>是编程的方法------重叠子问题</li></ol><br><p>动态规划是编程的方法指，可以借助编程的技巧去保证每个重叠的子问题只会被求解一次。</p><br><p>引出了动态规划的第二个重要的属性：重叠子问题（Overlapping Sub-problems）。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/0F/CgotOV2IcqKAee79ADIs6KpFExY310.gif" alt=""></p><p>下面通过几个小例题来判断其方法是否符合动态规划。</p><p><strong>举例 1</strong>：斐波那契数列问题。</p><br><p>解法：为了求出第 5 个斐波那契数，得先求出第 4 个和第 3 个数，但是在求第 4 个数的时候，又得重复计算一次第 3 个数，同样，对于第 2 个数的计算也出现了重复。</p><p>因此，判断一个问题能不能称得上是动态规划的问题，需要看它是否同时满足这两个重要的属性：最优子结构（Optimal Substructure）和重叠子问题（Overlapping Sub-problems）</p><p><strong>举例 2</strong>：给定如下的一个有向图，求出从顶点 A 到 C 的最长的路径。要求路径中的点只能出现一次。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/90/EF/CgoB5l2IcqOAXphFAA-GWGuo2C0144.gif" alt=""></p><p>按照题目的要求，可以看到，从 A 通往 C 有两条最长的路径：A -&gt; B -&gt; C 和 A -&gt; D -&gt; C。</p><br><p>对于 A -&gt; B -&gt; C，A 到 B 的最长距离是：A -&gt; D -&gt; C -&gt; B</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/0F/CgotOV2IcqSAeVmBABezjz1sSV0529.gif" alt=""></p><p>B 到 C 的最长距离是：B -&gt; A -&gt; D -&gt; C</p><p><img src="http://s0.lgstatic.com/i/image2/M01/90/EF/CgoB5l2IcqSAb1L3ABPxU8fyZuk520.gif" alt=""></p><p>组合路径：A -&gt; D -&gt; C -&gt; B -&gt; A -&gt; D -&gt; C</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/0F/CgotOV2IcqWAfxMeABZ4L440D5c286.gif" alt=""></p><p>上述答案并不满足题目的要求。该题并没有一个最优子结构，不是动态规划问题。</p><p><strong>举例 3</strong>：归并排序和快速排序是否属于动态规划？</p><br><p>解法：</p><ol><li><p>将要排序的数组分成两半，然后递归地进行处理，满足最优子结构的属性；</p></li><li><p>不断地对待排序的数组进行对半分的时候，两半边的数据并不重叠，不会遇到重复的子数组，不满足重叠子问题的属性。</p></li></ol><br><p>因此这两种算法不是动态规划的方法。</p><h6 id="例题分析" tabindex="-1">例题分析 <a class="header-anchor" href="#例题分析" aria-label="Permalink to &quot;例题分析&quot;">​</a></h6><p>LeetCode 第 300 题：给定一个无序的整数数组，找到其中最长子序列长度。</p><p>说明：</p><ul><li><p>可能会有多种最长上升子序列的组合，你只需要输出对应的长度即可。</p></li><li><p>你算法的时间复杂度应该为 O(n^2^） 。</p></li></ul><p>**注意：**子序列和子数组不同，它并不要求元素是连续的。</p><p>示例</p><p>输入：[ 10, 9, 2, 5, 3, 7, 101, 18 ]</p><p>输出：4</p><p>即，最长的上升子序列是 [2, 3, 7, 101]，它的长度是 4。</p><h3 id="解题思路" tabindex="-1">解题思路 <a class="header-anchor" href="#解题思路" aria-label="Permalink to &quot;解题思路&quot;">​</a></h3><p>在给定的数组里，有很多的上升子序列，例如：[10, 101]，[9, 101]，[2, 5, 7, 101]，以及 [2, 3, 7, 101]，只需要找出其中一个最长的。</p><p><strong>思路 1</strong>：暴力法</p><br><p>找出所有的子序列，然后从中返回一个最长的。</p><br><p>从一个数组中罗列出所有的非空子数组有： n×(n + 1)/2 种，即 O(n^2^)，那么罗列出所有的非空子序列有 2^n−1^ 种。复杂度将是 O(2^n^)。</p><p><strong>思路 2</strong>：缩小问题规模</p><br><ol><li>找最优子结构：输入规模对半分</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/90/EF/CgoB5l2IcqWAfAX8ACiK5xevrOI755.gif" alt=""></p><p>[10, 9, 2, 5] 最长的子序列应该是 [2, 5]，而 [3, 7, 101, 4] 最长的子序列是 [3, 7, 101]，由于 3 比 5 小，无法简单地组合在一起。即该方法下，总问题的解无法直观地通过子问题的最优解求得。</p><ol start="2"><li>找最优子结构：每次减一个</li></ol><br><p>假设 f(n) 表示的是数组 nums[0，...，n−1] 中最长的子序列，那么 f(n−1) 就是数组 nums[0，...，n−2] 中最长的子序列，依此类推，f(1) 就是 nums[0] 的最长子序列。</p><p>假设已经解决了 f(1)，f(2)，... f(n−1) 的问题，考虑最后一个数 nums[n−1]，也必然考虑到倒数第二个数 nums[n−2]，所以 f(n) 指：如果包含了最后的数，那么最长的子序列应该是什么。</p><p>注意：最后这个数必须包含在子序列当中的。</p><p>如何通过 f(1)，f(2)，...f(n−1) 推导出 f(n) 呢？由于最后一个数是 4，我们只需要在前面的 f(1)，f(2)，...f(n−1) 当中，找出一个以小于 4 的数作为结尾的最长的子序列，然后把 4 添加到最后，那么 f(n) 就一定是以 4 作为结尾的最长的子序列了。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/0F/CgotOV2IcqWAdiFJACpjs_86OCY252.gif" alt=""></p><p>最长的子序列并不一定会包含 4，遍历 f(1)，f(2)，...f(n−1) ，找出最长的。例如，以 101 结尾的最长的上升子序列是什么。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/90/EF/CgoB5l2IcqaAZ_nOADpppdMvQp0237.gif" alt=""></p><p>总结解决动态规划问题的两个难点。</p><br><p>（1）如何定义 f(n)</p><p>对于这道题而言，f(n) 是以 nums[n−1] 结尾的最长的上升子序列的长度</p><br><p>（2）如何通过 f(1)，f(2)，...f(n−1) 推导出 f(n)，即状态转移方程</p><p>本题中，nums[n−1] 和比它小的每一个值 nums[i] 进行比较，其中 1&lt;=i&lt;n，加 1 即可。因此状态转移方程就是：f(n)=max (1 &lt;= i &lt; n−1, nums[i−1] &lt; nums[n−1]) { f(i) } + 1</p><p>以上证明了这个问题有一个最优的子结构。</p><br><ol start="3"><li>找重叠子问题</li></ol><br><p>在分析最后一个数 4 的时候，以 3 结尾的最长的上升子序列长度就是 f(5)，因为 3 是第 5 个数。把问题规模缩小 2 个，当前的数变成 101 的时候，找比它小的数，又发现了 3，这个时候又会去重复计算一遍 f(5)，说明该题有重叠的子问题。</p><p>因此，可以运用动态规划的方法来解决这个问题。</p><h6 id="递归-recursion" tabindex="-1">递归（Recursion） <a class="header-anchor" href="#递归-recursion" aria-label="Permalink to &quot;递归（Recursion）&quot;">​</a></h6><p>用递归的方法求解状态转移方程式 f(n)=max (1 &lt;= i &lt; n−1, nums[i−1] &lt; nums[n−1]) { f(i) } + 1。</p><ul><li><p>对于每个 n，要从 0 开始遍历</p></li><li><p>在 n 之前，找出比 nums[n−1] 小的数</p></li><li><p>递归地调用 f 函数，找出最大的，最后加上 1</p></li><li><p>当 i 等于 0 的时候，应该返回 0；当 i 等于 1 的时候应该返回 1。</p></li></ul><h6 id="代码实现" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现" aria-label="Permalink to &quot;代码实现&quot;">​</a></h6><p>下面就是递归的代码实现。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">class LISRecursion {</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br></div></div><br><p>其中，实现状态转移方程，即 f 函数。</p><ul><li><p>最基本的情况，当数组的长度为 0 时，没有上升子序列，当数组长度为 1 时，最长的上升子序列长度是 1。</p></li><li><p>maxEndingHere 变量的含义就是包含当前最后一个元素的情况下，最长的上升子序列长度。</p></li></ul><h6 id="时间复杂度" tabindex="-1">时间复杂度 <a class="header-anchor" href="#时间复杂度" aria-label="Permalink to &quot;时间复杂度&quot;">​</a></h6><p>用公式法解决该递归问题的时间复杂度，如下。</p><br><p>当 n=1 的时候，递归直接返回 1，执行时间为 O(1)，即 T(1)=O(1)</p><p>当 n=2 的时候，内部调用了一次递归求解 T(1)，所以 T(2)=T(1)</p><p>当 n=3 的时候，T(3)=T(1) + T(2)</p><p>...</p><p>以此类推，</p><p>T(n−1)=T(1) + T(2) + ... + T(n−2)</p><p>T(n)=T(1) + T(2) + ... + T(n−1)</p><p>通过观察，我们得到：T(n)=2×T(n−1)，这并不满足 T(n)=a×T(n / b) + f(n) 的关系式。但是 T(n) 等于两倍的 T(n−1)，表明，我们的计算是成指数增长的，每次的计算都是先前的两倍。所以 O(n)=O(2^n^)。</p><h6 id="记忆化-memoization" tabindex="-1">记忆化（Memoization） <a class="header-anchor" href="#记忆化-memoization" aria-label="Permalink to &quot;记忆化（Memoization）&quot;">​</a></h6><p>由于递归的解法需要耗费非常多的重复计算，而且很多计算都是重叠的，避免重叠计算的一种办法就是记忆化。</p><p>记忆化，就是将已经计算出来的结果保存起来，那么下次遇到相同的输入时，直接返回保存好的结果，能够有效节省了大量的计算时间。</p><h6 id="代码实现-1" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现-1" aria-label="Permalink to &quot;代码实现&quot;">​</a></h6><p>在之前递归实现的基础上实现记忆化，代码如下。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">class LISMemoization {</span></span>
<span class="line"><span style="color:#E1E4E8;">    static int max;</span></span>
...
<span class="line"><span style="color:#24292E;">        return maxEndingHere;</span></span>
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br></div></div><h2 id="时间复杂度-1" tabindex="-1">时间复杂度 <a class="header-anchor" href="#时间复杂度-1" aria-label="Permalink to &quot;时间复杂度&quot;">​</a></h2><p>分析递归+记忆化的时间复杂度，如下。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/0F/CgotOV2IcqaAZ_YzABSfIxvIih8411.gif" alt=""></p><ol><li><p>函数 f 按序传递n，n−1，n−2 ... 最后是 1，把结果缓存并返回；</p></li><li><p>递归返回到输入 n；</p></li><li><p>缓存里已经保存了 n−1 个结果；</p></li><li><p>for 循环调用递归函数 n−1 次，从 cache 里直接返回结果。</p></li></ol><br><p>上述过程的时间复杂度是 O(1)。即将问题的规模大小从 n 逐渐减小到 1 的时候，通过将各个结果保存起来，可以将 T(1)，T(2)，....T(n−1) 的复杂度降低到线性的复杂度。</p><p>现在，回到 T(n)，在 for 循环里，尝试着从 T(1)，T(2)....T(n−1) 里取出最大值，因此 O(T(n))=O(T(1) + T(2) + ... + T(n−1))=O(1 + 2 + .... + n−1)=O(n×(n−1)/2)=O(n^2^)。</p><p>最后加上构建缓存 cache 的时间，整体的时间复杂度就是 O(f(n))=O(n) + O(n^2)=O(n^2^)。</p><p>通过记忆化的操作，我们把时间复杂度从 O(2^n^) 降低到了 O(n^2^)。</p><p>这种将问题规模不断减少的做法，被称为自顶向下的方法。但是，由于有了递归的存在，程序运行时对堆栈的消耗以及处理是很慢的，在实际工作中并不推荐。更好的办法是自底向上。</p><h6 id="自底向上-bottom-up" tabindex="-1">自底向上（Bottom-Up） <a class="header-anchor" href="#自底向上-bottom-up" aria-label="Permalink to &quot;自底向上（Bottom-Up）&quot;">​</a></h6><p>自底向上指，通过状态转移方程，从最小的问题规模入手，不断地增加问题规模，直到所要求的问题规模为止。依然使用记忆化避免重复的计算，不需要递归。</p><p>建议：在面试的时候，如果能最终给出一个自底向上的方案和代码，则比较完美。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">class LISDP {</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">    </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h6 id="时间复杂度-2" tabindex="-1">时间复杂度 <a class="header-anchor" href="#时间复杂度-2" aria-label="Permalink to &quot;时间复杂度&quot;">​</a></h6><p>由上可知，这一个双重循环。当 i=0 的时候，内循环执行 0 次；当 i=1 的时候，内循环执行 1 次......以此类推，当 i=n−1 的时候，内循环执行了 n−1 次，因此，总体的时间复杂度是 O(1 + 2 + .. + n−1)=O(n×(n−1) / 2)=O(n^2^)。</p><h6 id="动态规划面试题分类" tabindex="-1">动态规划面试题分类 <a class="header-anchor" href="#动态规划面试题分类" aria-label="Permalink to &quot;动态规划面试题分类&quot;">​</a></h6><p>运用动态规划去解决问题，最难的地方有两个：</p><ol><li><p>应当采用什么样的数据结构来保存什么样的计算结果</p></li><li><p>如何利用保存下来的计算结果推导出状态转移方程</p></li></ol><br><p>第一个难点，不仅是为了避免重复的计算，也是推导状态转移方程的关键。这一难点往往是在把问题规模缩小的过程中进行的。</p><p>解决技巧：假设已经把所有子问题的最佳结果都计算出来了，那么只需要考虑，如何根据这些子问题的结果来得出最终的答案。</p><p>根据动态规划问题的难易程度，把常见的动态规划面试题分成如下三大类。</p><h6 id="线性规划" tabindex="-1">线性规划 <a class="header-anchor" href="#线性规划" aria-label="Permalink to &quot;线性规划&quot;">​</a></h6><p>面试题中最常见也是最简单的一种。</p><p>线性，就是说各个子问题的规模以线性的方式分布，并且子问题的最佳状态或结果可以存储在一维线性的数据结构里，例如一维数组，哈希表等。</p><p>解法中，经常会用 dp[i] 去表示第 i 个位置的结果，或者从 0 开始到第 i 个位置为止的最佳状态或结果。例如，最长上升子序列。dp[i] 表示从数组第 0 个元素开始到第i个元素为止的最长的上升子序列。</p><p>求解 dp[i] 的复杂程度取决于题目的要求，但是基本上有两种形式。</p><h3 id="求解-dp-i-形式一" tabindex="-1"><strong>求解 dp[i] 形式一</strong> <a class="header-anchor" href="#求解-dp-i-形式一" aria-label="Permalink to &quot;**求解 dp\\[i\\] 形式一**&quot;">​</a></h3><p>第一种形式，当前所求的值仅仅依赖于有限个先前计算好的值，也就是说，dp[i] 仅仅依赖于有限个 dp[j]，其中 j &lt; i。</p><p><strong>举例 1</strong>：斐波那契数列。</p><br><p>解法：dp[i]=dp[i−1] + dp[i−2]，可以看到，当前值只依赖于前面两个计算好的值。</p><br><p>建议：LeetCode 第 70 题（爬楼梯）就是一道求解斐波那契数列的题目。</p><p><strong>举例2</strong>：LeetCode第 198 题，给定一个数组，不能选择相邻的数，求如何选才能使总数最大。</p><br><p>解法：这道题需要运用经典的 0-1 思想，简单说就是：&quot;选还是不选&quot;。</p><br><p>假设 dp[i] 表示到第 i 个元素为止我们所能收获到的最大总数。</p><ul><li><p>如果选择了第 i 个数，则不能选它的前一个数，因此，收获的最大总数就是 dp[i−2] + nums[i]。</p></li><li><p>不选，则直接考虑它的前一个数 dp[i−1]。因此，可以推导出它的递归公式 dp[i]=max(nums[i] + dp[i−2], dp[i−1])，可以看到，dp[i] 仅仅依赖于有限个 dp[j]，其中 j=i−1，i−2。</p></li></ul><p><strong>代码实现</strong></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">public int rob(int[] nums) {</span></span>
