import{_ as e,o as t,g as r,Q as p}from"./chunks/framework.f949202b.js";const y=JSON.parse('{"title":"知识回顾 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/frontEnd/109-TypeScript 入门实战笔记文档/(7453) 结束语  TypeScript 的这些实用技能，你不得不知.md","filePath":"posts/frontEnd/109-TypeScript 入门实战笔记文档/(7453) 结束语  TypeScript 的这些实用技能，你不得不知.md","lastUpdated":null}'),a={name:"posts/frontEnd/109-TypeScript 入门实战笔记文档/(7453) 结束语  TypeScript 的这些实用技能，你不得不知.md"},n=p(`<p>经过前面 20 讲的学习，我们已经了解了 TypeScript 从开发环境搭建、基础类型、高阶类型到业务实践的全链路知识。</p><p>最后一讲我们再一起对过往实用的技能、重点或者容易混淆的知识进行提炼汇总，查漏补缺。</p><h3 id="知识回顾" tabindex="-1">知识回顾 <a class="header-anchor" href="#知识回顾" aria-label="Permalink to &quot;知识回顾&quot;">​</a></h3><h4 id="number、string、boolean、symbol" tabindex="-1">Number、String、Boolean、Symbol <a class="header-anchor" href="#number、string、boolean、symbol" aria-label="Permalink to &quot;Number、String、Boolean、Symbol&quot;">​</a></h4><p>首先，我们来回顾一下初学 TypeScript 时，很容易和原始类型 number、string、boolean、symbol 混淆的首字母大写的 Number、String、Boolean、Symbol 类型，后者是相应原始类型的包裹对象，姑且把它们称之为对象类型。</p><p>从类型兼容性上看，原始类型兼容对应的对象类型，反过来对象类型不兼容对应的原始类型。</p><p>下面我们看一个具体的示例：</p><pre><code>let num: number;
let Num: Number;
Num = num; // ok
num = Num; // ts(2322)
