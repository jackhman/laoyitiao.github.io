import{_ as p,D as l,o as e,g as o,J as t,h as n,m as s,Q as c}from"./chunks/framework.f67d7268.js";const U=JSON.parse('{"title":"35中介者模式：如何通过中间层来解决耦合过多的问题？","description":"","frontmatter":{},"headers":[],"relativePath":"posts/backEnd/趣学设计模式_文档/(6900) 35  中介者模式：如何通过中间层来解决耦合过多的问题？.md","filePath":"posts/backEnd/趣学设计模式_文档/(6900) 35  中介者模式：如何通过中间层来解决耦合过多的问题？.md","lastUpdated":1696682708000}'),r={name:"posts/backEnd/趣学设计模式_文档/(6900) 35  中介者模式：如何通过中间层来解决耦合过多的问题？.md"},i=s("h1",{id:"_35中介者模式-如何通过中间层来解决耦合过多的问题",tabindex:"-1"},[n("35中介者模式：如何通过中间层来解决耦合过多的问题？ "),s("a",{class:"header-anchor",href:"#_35中介者模式-如何通过中间层来解决耦合过多的问题","aria-label":'Permalink to "35中介者模式：如何通过中间层来解决耦合过多的问题？"'},"​")],-1),E=s("p",null,"中介者模式理解起来并不难，代码实现简单，学习难度也很小，只要合理充分地应用这个模式，往往就能够解决一些意想不到的问题。那这到底是怎样一个模式？多用于什么场景中？为什么使用？该怎么使用？",-1),y=s("p",null,"话不多说，让我们带着这些问题开始今天的学习吧。",-1),d=s("h3",{id:"模式原理分析",tabindex:"-1"},[n("模式原理分析 "),s("a",{class:"header-anchor",href:"#模式原理分析","aria-label":'Permalink to "模式原理分析"'},"​")],-1),u=s("p",null,"中介者模式的原始定义是：中介者对象封装了一组对象之间的交互，这组对象会将它们的交互委托给中介者对象，而不是直接交互。",-1),m=s("p",null,"可以看到，这个定义是难得的简单和明确，中介者对象就是用于处理对象与对象之间的直接交互，封装了多个对象之间的交互细节。",-1),g=s("p",null,"我们还是先来看看中介者模式的 UML 图：",-1),h=c(`<p>中介者模式的 UML 图</p><p>从这个 UML 图中，我们能看出中介者模式包含了四个关键角色。</p><ul><li><p><strong>抽象中介者</strong>（Mediator）：定义中介者需要执行的方法操作。</p></li><li><p><strong>具体中介者</strong>（MediatorImpl）：实现抽象中介者定义的方法操作，同时可以包含更多逻辑。</p></li><li><p><strong>抽象组件类</strong>（Component）：定义组件需要执行的方法操作。</p></li><li><p><strong>具体组件类</strong>（ComponentA、ComponentB）：继承自抽象组件类，实现具体的组件业务逻辑。</p></li></ul><p>下面我们再来看看 UML 对应的代码实现：</p><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">public interface Mediator {</span></span>
