import{_ as l,j as p,o,g as e,k as a,Q as s}from"./chunks/framework.4e7d56ce.js";const D=JSON.parse('{"title":"provide API ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7635) 11  依赖注入：子孙组件如何共享数据？.md","filePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7635) 11  依赖注入：子孙组件如何共享数据？.md","lastUpdated":1696417798000}'),t={name:"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7635) 11  依赖注入：子孙组件如何共享数据？.md"},c=s(`<p>Vue.js 为我们提供了很多组件通讯的方式，常见的是父子组件通过 prop 传递数据。但是有时，我们希望能<strong>跨父子组件通讯</strong>，比如，无论组件之间嵌套多少层级，我都希望在后代组件中能访问它们祖先组件的数据。</p><p>Vue.js 2.x 给我们提供了一种依赖注入的解决方案，即在祖先组件提供一个 provide 选项，举个例子：</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// Provider </span></span>
