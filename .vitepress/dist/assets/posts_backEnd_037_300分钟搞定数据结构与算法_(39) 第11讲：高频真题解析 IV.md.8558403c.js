import{_ as s,o as n,g as a,Q as l}from"./chunks/framework.f949202b.js";const d=JSON.parse('{"title":"例题分析一 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/backEnd/037_300分钟搞定数据结构与算法/(39) 第11讲：高频真题解析 IV.md","filePath":"posts/backEnd/037_300分钟搞定数据结构与算法/(39) 第11讲：高频真题解析 IV.md","lastUpdated":null}'),p={name:"posts/backEnd/037_300分钟搞定数据结构与算法/(39) 第11讲：高频真题解析 IV.md"},e=l(`<p>这节课继续来看几道面试中的难题：</p><ul><li><p>回文对</p></li><li><p>至多包含 K 个不同字符的最长子串</p></li><li><p>接雨水 II</p></li></ul><h6 id="例题分析一" tabindex="-1">例题分析一 <a class="header-anchor" href="#例题分析一" aria-label="Permalink to &quot;例题分析一&quot;">​</a></h6><p>LeetCode 第 336 题，回文对：给定一组唯一的单词， 找出所有不同的索引对 (i, j)，使得列表中的两个单词， words[i] + words[j] ，可拼接成回文串。</p><p><strong>示例 1</strong></p><p>输入: [&quot;abcd&quot;,&quot;dcba&quot;,&quot;lls&quot;,&quot;s&quot;,&quot;sssll&quot;]</p><p>输出: [[0,1],[1,0],[3,2],[2,4]]</p><p>解释: 可拼接成的回文串为 [&quot;dcbaabcd&quot;,&quot;abcddcba&quot;,&quot;slls&quot;,&quot;llssssll&quot;]</p><p><strong>示例 2</strong></p><p>输入: [&quot;bat&quot;,&quot;tab&quot;,&quot;cat&quot;]</p><p>输出: [[0,1],[1,0]]</p><p>解释: 可拼接成的回文串为 [&quot;battab&quot;,&quot;tabbat&quot;]</p><h6 id="解题思路-暴力法" tabindex="-1">解题思路：暴力法 <a class="header-anchor" href="#解题思路-暴力法" aria-label="Permalink to &quot;解题思路：暴力法&quot;">​</a></h6><p>所谓回文，就是正读和反读都一样的字符串，例如&quot;leetteel&quot;。</p><p>检查一个字符串是否是回文，方法如下。</p><ol><li><p>将给定的字符串翻转，然后跟原字符串对比，看是否相等。但空间复杂度为 O(n) 。</p></li><li><p>定义两个指针 i、j，一个指向字符串的头，一个指向字符串的尾巴，同时从两头进行检查，一旦发现不相等就表明不是回文，一直检查到两个指针相遇为止。</p></li></ol><p>将上述方法 2 用代码实现如下。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">boolean isPalindrome(String word, int i, int j) {</span></span>
...
<span class="line"><span style="color:#24292E;">  </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><br><p>代码非常简单，因此不作过多讲解。</p><p>回到例题本身，用暴力法怎么解。</p><p>实现方法：</p><ul><li><p>先找出所有的两两组合</p></li><li><p>对每种组合进行排查，看看哪种组合可以构成回文。</p></li></ul><br><p>时间复杂度：</p><ul><li><p>假设一共有 n 个单词，每个单词的平均长度为 k，两两组合，有 P(n, 2) = n×(n - 1) 种；</p></li><li><p>对组合的字符串进行回文检查，需要 2k 的时间复杂度；</p></li><li><p>最终的时间复杂度是：O(n2×k)。</p></li></ul><h6 id="暴力法优化" tabindex="-1">暴力法优化 <a class="header-anchor" href="#暴力法优化" aria-label="Permalink to &quot;暴力法优化&quot;">​</a></h6><p>暴力法需要检查哪些情况？</p><p>进行回文检查的时候，根据两个字符串的长度不同的程度，假设组合字符串的长度分别为 k1、k2，那么会出现以下三种情况。</p><ul><li>k1 = k2</li></ul><p>举例：字符串 s1 = &quot;abcd&quot;，字符串 s2 = &quot;dcba&quot;</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q2AHWZiAAA5qCvSGLk571.png" alt=""></p><p>实现：同时从两边进行检查，看看它们能否构成回文，构成回文的条件就是两个指针相遇，或者同时扫描完两个字符串。</p><ul><li>k1 &gt; k2</li></ul><p>举例：s1 = &quot;abcdefe&quot;，s2 = &quot;dcba&quot;</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4Q2ATkxxAABJBdsgXhA725.png" alt=""></p><p>实现：同时从两头进行检查，由于 s2 的长度短，那么 s2 首先会被遍历完毕，此时 s1 还剩下的部分必须要满足回文。</p><ul><li>k1 &lt; k2</li></ul><p>举例：s1 = &quot;abcd&quot;，s2 = &quot;efedcba&quot;</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q2AEHAWAABJfYeVV4k708.png" alt=""></p><p>实现：跟第二种情况类似，同时从两头进行检查，由于 s1 的长度短，s1 首先会被遍历完毕，此时 s2 还剩下的部分必须满足回文。</p><p>暴力法如何优化？</p><p>暴力法之所以那么慢，是因为它要对所有情况进行检查。而对于 s1 = &quot;abcd&quot; ，s1 + s2 的组合构成回文的一个条件就是，s2 的最后一个字符必须是 a，如果 k2&gt;=2，它最后两个字符一定是 ba。不满足条件的字符串，不需要理会。</p><p>那么，如何能快速地知道哪些字符串以 a 结尾，哪些字符串以 ba 结尾呢？</p><p>如果反看 s2 ，这个问题相当于，怎么能快速地找出所有以 a 开头或者以 ab 开头的字符串？第 2 节课里介绍的 Trie，正是快速查找以某个字符串开头的数据结构。</p><p>注意：此处要对每个字符串反着构建 Trie。</p><h3 id="trie" tabindex="-1"><strong>Trie</strong> <a class="header-anchor" href="#trie" aria-label="Permalink to &quot;**Trie**&quot;">​</a></h3><p>一个 Trie 一般都是由很多个 TrieNode 节点构成的，最普通的 TrieNode 节点一般有以下的结构。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">class TrieNode {</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><br><p>其中，</p><ul><li><p>children：数组或者集合，罗列出每个分支当中包含的所有字符</p></li><li><p>isEnd：布尔值，表示该节点是否为某字符串的结尾</p></li></ul><p>由上可知，Trie 是一种通过字符链接起来的树状结构，且 Trie 一定有一个根节点 root，它的 children 集合包含了所有字符串的开头那个字符。</p><p>举例：给定一系列字符串：&quot;ab&quot;, &quot;abc&quot;, &quot;abde&quot;, &quot;bcd&quot;，用 Trie 表示的结构如下。</p><br><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4Q2AHbOfAABrqvMxUVU130.png" alt=""></p><p>其中，</p><ul><li><p>字符作为链接每个节点的边，这些字符也是哈希表里的 key。</p></li><li><p>这些 key 对应的 value 是节点，绿色的节点表示节点里的 isEnd 布尔值为 true，也就是这个节点表示了一个字符串的结束。</p></li><li><p>要利用这个 Trie 来查找所有以 b 字符开头的字符串时，可以避开左边三个以 a 字母开头的字符串。</p></li></ul><h3 id="构建-tire" tabindex="-1">构建 Tire <a class="header-anchor" href="#构建-tire" aria-label="Permalink to &quot;构建 Tire&quot;">​</a></h3><p>将给定的字符串变成 &quot;ba&quot;，&quot;cba&quot;，&quot;edba&quot;，&quot;dcb&quot;，它们其实就是之前的字符串的翻转。对它们逆序进行 Trie 的构建，也得出了相同的结构。为了能让给定的字符串能组合成回文，再添加两个字符串：&quot;a&quot;，&quot;abc&quot;，同时，把&quot;dcb&quot; 删除，Trie 变成了下面的结构。</p><br><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q2AGNocAABw4HvSobY774.png" alt=""></p><p>就之前提到的三种情况来分析如何利用 Trie 判断合并两个字符串能否构成回文。基本上是同时遍历字符串和Trie。</p><ul><li>k1 = k2，即两个字符串的长度相同并且能够构成回文</li></ul><p>举例：s1 = &quot;abc&quot;，s2 = &quot;cba&quot;，s1+s2 = &quot;abccba&quot;。</p><ol><li><p>从 s1 的第一个字符 a 开始，Trie 里有记录以 a 结尾的字符串，其他那些不是以 a 结尾的字符串不予考虑。</p></li><li><p>第二个字符 b，那么从 a 节点开始，看看有没有以 b 作为键值 key 的节点，有，继续。</p></li><li><p>第三个字符 c，在 Trie 里，从 b 指向的节点开始，看看有没有以 c 作为键值的节点，有，继续。那些不是以 c 作为键值的分支可以不必考虑。</p></li><li><p>字符串遍历结束，在 Trie 里，当前节点是 c 指向的节点。由于该节点恰好表示字符串&quot;cba&quot;的结束，因此，得出两个字符串合在一起可以构成回文串。</p></li></ol><ul><li>k1 &gt; k2</li></ul><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4Q-AFUARAFdBFfNwj4s416.gif" alt=""></p><p>举例：s1 = &quot;abc&quot;，s2 = &quot;ba&quot; ，s1+s2 =&quot;abcba&quot;。</p><ol><li><p>从 s1 的第一个字符 a 开始，能从 Trie 里找到 a，于是继续。</p></li><li><p>字符 b，也能找到，并且 b 指向的节点是一个绿色节点，即从 Trie 里找到了字符&quot;ba&quot;。</p></li><li><p>要能使 s1 + s2 构成回文，条件就是 s1 里剩下的部分也是回文，此时 s1 剩下的是字符 c，而字符 c 是回文，因此，&quot;abc&quot; 和 &quot;ba&quot;能构成回文串。</p></li></ol><ul><li>k1 &lt; k2</li></ul><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RGAdPAxAGKOo26J4J8733.gif" alt=""></p><p>举例：s1 = &quot;a&quot;，s2 = &quot;ba&quot;，s1+s2 =&quot;aba&quot;。</p><br><p>当 s1 遍历完毕后，Trie 来到了 b 节点，由于 b 也是回文，因此它们两个也能构成回文串。</p><p>对于情况一、三：</p><ol><li><p>s1 字符串一定会被遍历完毕</p></li><li><p>遍历完毕后，在 Trie 里所对应的节点</p></li></ol><ul><li><p>是 s2 中的最后一个字符；</p></li><li><p>是 s2 的剩余字符</p><ul><li>只要该剩余字符本身是回文，就可以给这个节点添加一个数组，用来记录从该节点向后所有剩余能构成回文的字符串的下标即可。</li></ul></li></ul><p>对于情况二：</p><ol><li><p>在 Trie 里，当遇到某个绿色节点，而它表示了某个字符串的结束，只要 s1 剩下的字符能构成回文即可。</p></li><li><p>修改 isEnd，用 index 替代，来得到 Trie 里 s2 的下标。</p><ol><li><p>当 index 为 -1 时，表示不是字符串的结束位置。</p></li><li><p>当是字符串的结束时，用 index 来记录输入字符串的下标即可。</p></li></ol></li></ol><h6 id="代码实现" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现" aria-label="Permalink to &quot;代码实现&quot;">​</a></h6><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">// 修改 TrieNode 结构，用 index 替换 isEnd</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><br><p>主函数代码如下。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">List&lt;</span><span style="color:#FDAEB7;font-style:italic;">List&lt;Integer</span><span style="color:#E1E4E8;">&gt;&gt; palindromePairs(String[] words) {</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><br><p>创建 Tire 如下。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">// 创建 Trie 的时候，从每个字符串的末尾开始遍历</span></span>
...
<span class="line"><span style="color:#24292E;">  </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><br><p>若该字符串从头开始到当前位置能成为回文的话，把这个字符串的下标添加到这个 Trie 节点的回文列表里。例如，如果字符串是&quot;aaaba&quot;，由于我们从后面往前面遍历，当遍历到字符 b 的时候，发现 aaa 是回文，于是更新 b 所指向的那个节点，说该节点往下有一个字符串能构成回文。</p><p>处理查找如下。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">// 处理查找，从头遍历每个字符串，然后从 Trie 里寻找匹配的字符串</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br></div></div><h6 id="复杂度分析" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h6><p>利用 Trie，在创建和查找的过程中，最多会遇到 n×k 个节点，而且会进行回文检查，所以整体的时间复杂度是：O(n×k×k)。</p><p>如果字符串的字符个数是在一定范围之内的，那么这个问题就可以优化成一个近乎于线性问题了。</p><h6 id="例题分析二" tabindex="-1">例题分析二 <a class="header-anchor" href="#例题分析二" aria-label="Permalink to &quot;例题分析二&quot;">​</a></h6><p>LeetCode 第 340 题：给定一个字符串 s ，找出至多包含 k 个不同字符的最长子串 T。</p><p><strong>示例 1</strong></p><p>输入: s = &quot;eceba&quot;, k = 2</p><p>输出: 3</p><p>解释: 则 T 为 &quot;ece&quot;，所以长度为 3。</p><p><strong>示例 2</strong></p><p>输入: s = &quot;aa&quot;, k = 1</p><p>输出: 2</p><p>解释: 则 T 为 &quot;aa&quot;，所以长度为 2。</p><h6 id="解题思路-暴力法-1" tabindex="-1">解题思路：暴力法 <a class="header-anchor" href="#解题思路-暴力法-1" aria-label="Permalink to &quot;解题思路：暴力法&quot;">​</a></h6><p>思路：找出所有的子串，然后逐一检查是否最多包含 k 个不同的字符。</p><br><p>实现：用一个哈希表或者哈希集合去统计。</p><br><p>复杂度：O(n^2)。</p><p>第 8 课讲解了一道 LeetCode 的题目，给定一个字符串，找出无重复字符的最长子串。当时提出了一种比较聪明的办法，能够在 O(n) 的时间里找到答案。上述例题其实是它的另外一种扩展，可以运用相似的策略来进行。</p><p>举例：s = &quot;eceba&quot;，k = 2。</p><p>实现过程如下。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RGActCuAACWTDVjmS4562.png" alt=""></p><p>用两个快慢指针：i 和 j，i 是慢指针，j 是快指针。一开始，两个指针都指向字符串的开头。另外，还需要一个哈希表来统计每个字符出现的个数，同时用来统计不同字符的个数。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RGAIz3YAACUEV4BZ10058.png" alt=""></p><ol><li>每次将快指针指向的字符添加到哈希表中，统计它出现的次数。第一个字符是 e，加入到 map 中。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RKAYjhXAA248QeqTy0883.gif" alt=""></p><ol start="2"><li>map 的大小为 1，表明到目前为止出现了一个字符。由于 map 的大小还没有超过 k，快指针向前移动一步。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RKAB20KAA0Y_xJpZGc219.gif" alt=""></p><ol start="3"><li>j 指向的字符是 c，同样统计到 map 中，此时 map 的大小为 2，也没有超过 k，快指针继续移动。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RKAQZMoAACUJa2fTUI207.png" alt=""></p><ol start="4"><li>当前 j 指向的字符是 e，现在 e 出现了 2 次，但是 map 的大小还是 2，表明到目前为止只看到两个不同的字符，即 e 和 c。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4ROAXs2mABP3Qvxxwgc796.gif" alt=""></p><ol start="5"><li>继续移动 j 指针，出现了新的字符 b，加入到 map 中。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4ROABmg9ACHl6sZ0cUE027.gif" alt=""></p><ol start="6"><li>此时 map 的大小为 3，已经超过了 2，于是慢指针开始删除字符，目的是为了控制住 map 的大小不超过 2。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RSAS2V0AAwyhXeaga4800.gif" alt=""></p><ol start="7"><li>当把第一个字符删除的时候，在 map 里更新 e 字符的计数，但是整个 map 的大小还是等于 3，继续相同的操作。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RSAP5kkABVxWpINXZU330.gif" alt=""></p><ol start="8"><li>c 的个数只有一个，直接把它从 map 里删除掉。现在 map 的大小恢复正常，继续移动快指针。</li></ol><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RWAEvZNAB6BcQzB1BA923.gif" alt=""></p><ol start="9"><li><p>当把 a 添加到 map 里后，map 的大小又超过了 2，于是移动慢指针，把它指向的字符从 map 中删除掉。</p></li><li><p>结束循环。</p></li></ol><h6 id="代码实现-1" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现-1" aria-label="Permalink to &quot;代码实现&quot;">​</a></h6><ul><li><p>初始化一个哈希表 map，用来统计所出现了的不同字符。</p></li><li><p>用 max 变量记录最长的子串，其中子串最多包含 k 个不同的字符。</p></li><li><p>用快慢指针遍历字符串。</p></li><li><p>将快指针指向的字符加入到 map 中，统计字符出现的次数。</p></li><li><p>如果发现 map 的大小超过了 k，那么就得开始不断地将慢指针所指向的字符从 map 里清除掉。</p></li><li><p>首先获取当前慢指针指向的字符。</p></li><li><p>将它在map中的计数减一。</p></li><li><p>一旦它的统计次数变成了 0，就可以把它从 map 中删掉了。</p></li><li><p>接下来，慢指针继续往前走。</p></li><li><p>当 map 的大小恢复正常了，统计一下当前子串的长度。</p></li><li><p>最后返回最大的子串长度。</p></li></ul><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">int lengthOfLongestSubstringKDistinct(String s, int k) {</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br></div></div><h6 id="复杂度分析-1" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析-1" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h6><p>快慢指针遍历字符串一遍，时间复杂度为 O(n)。</p><p>运用了一个 map来作统计，空间复杂度为 O(n)。</p><h6 id="例题分析三" tabindex="-1">例题分析三 <a class="header-anchor" href="#例题分析三" aria-label="Permalink to &quot;例题分析三&quot;">​</a></h6><p>LeetCode 第 407 题：给定一个 m x n 的矩阵，其中的值均为正整数，代表二维高度图每个单元的高度，请计算图中形状最多能接多少体积的雨水。</p><p>说明：m 和 n 都是小于 110 的整数。每一个单位的高度都大于 0 且小于 20000。</p><p>示例：</p><p>给出如下 3x6 的高度图:</p><p>[</p><p>[1,4,3,1,3,2],</p><p>[3,2,1,3,2,4],</p><p>[2,3,3,2,3,1]</p><p>]</p><p>返回 4。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4ReAeHXlAIqi3-dedKM816.gif" alt=""></p><ol><li><p>下雨前的高度图 [[1,4,3,1,3,2],[3,2,1,3,2,4],[2,3,3,2,3,1]]。</p></li><li><p>下雨后，雨水将会被存储在这些方块中，总的接雨水量是 4。</p></li></ol><h6 id="解题思路一-从内向外" tabindex="-1">解题思路一：从内向外 <a class="header-anchor" href="#解题思路一-从内向外" aria-label="Permalink to &quot;解题思路一：从内向外&quot;">​</a></h6><h3 id="基本情况" tabindex="-1">基本情况 <a class="header-anchor" href="#基本情况" aria-label="Permalink to &quot;基本情况&quot;">​</a></h3><p>举例：假如有一个点高度是 0，而它四周的柱子的高度分别是 1，2，3，4。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4ReAKOakAABLZGpg3no849.png" alt=""></p><br><p>解法：中间的那个位置最多能接高度为 1 的水，因为它的四周最矮的柱子是 1。</p><h3 id="扩展情况" tabindex="-1">扩展情况 <a class="header-anchor" href="#扩展情况" aria-label="Permalink to &quot;扩展情况&quot;">​</a></h3><p>举例：假设现在 0 的周围是如下情况，那么 0 那个位置能接水的高度还是 1 吗？</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RiAE6xSAABpFZMq9Kc568.png" alt=""></p><p>答案应该是 4。</p><p>总结思路：对于每个点，都要不断地往外去寻找那个高过自己的最矮的柱子。假设在平面上，一共有 n 个点，按照这样的算法去计算所有的点的接水高度，复杂度是 O(n^3)。</p><h2 id="解题思路二-从外向内" tabindex="-1">解题思路二：从外向内 <a class="header-anchor" href="#解题思路二-从外向内" aria-label="Permalink to &quot;解题思路二：从外向内&quot;">​</a></h2><p>为了提高效率，采用&quot;农村包围城市&quot;的策略，从外面往里面进行计算。</p><p>者是因为，每个点都必须找到最外围的高度，否则无法确定它能接多少雨水。既然如此，为什么不从最外面开始呢？即，每一次我们都从外面最矮的开始，慢慢地往里面计算。</p><p>以上述例子说明。</p><p><img src="http://s0.lgstatic.com/i/image2/M01/91/51/CgoB5l2I4RiAR15vAACREQ7D-94461.png" alt=""></p><br><p><img src="http://s0.lgstatic.com/i/image2/M01/91/71/CgotOV2I4RmAE6UaADwhl85qEAo165.gif" alt=""></p><ol><li><p>最外围开始，而最外围的方块无法承载雨水。</p></li><li><p>从最外围的高度中选择最矮的柱子，先对它的邻居进行处理。这是因为决定能够接多少雨水并不是由周围最高的柱子决定，而是由最矮的决定。</p></li><li><p>高度 4 是最矮的，于是对其做 BFS，它的邻居是高度为 2 的方块。</p></li><li><p>由于 2 小于 4，2 的位置能够接纳高度为 2 的雨水，于是这个位置上的高度就变成了 4。</p></li><li><p>还是从最矮的点出发，还是 4，它的邻居是 0，于是 0 所能接的雨水高度就是 4。</p></li><li><p>还是 4 是最矮，可以更新它周围的点在接了雨水后的高度。</p></li></ol><p>那么，如何快速知道接下来哪个高度最矮呢？可以用优先队列来提高速度。</p><h6 id="代码实现-2" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现-2" aria-label="Permalink to &quot;代码实现&quot;">​</a></h6><p>代码实现如下，为了配合优先队列的操作，定义一个 Cell 类，用来保存每个方块的坐标以及接了雨水后的高度。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">class Cell {</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>首先对输入进行一些基本的判断。用变量 m 和 n 分别表示输入矩阵的行数和列数。定义一个优先队列或者最小堆，按照每个方块接雨水后的高度排列。初始化优先队列的时候，把矩形的外围四个边上的方块都加入到优先队列中。</p><p>进入 while 循环，开始进行 BFS。每次，从优先队列中取出高度最矮的方块。从四个方向扩散。该方向上的邻居方块能接多少雨水，取决于它是否低于当前的方块了。同时，将新方块加入到优先队列中。</p><p>最后返回承接雨水的总量。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">public int trapRainWater(int[][] heights) {</span></span>
...
<span class="line"><span style="color:#24292E;">  </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br></div></div><h6 id="复杂度分析-2" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析-2" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h6><p>假设一共有 m 行 n 列，那么一共有 m×n 个方块。对于每个方块，都有可能会进行优先队列的操作，而优先队列的大小为 m + n，加上初始化优先队列的操作时间，因此，整体的时间复杂度为 O(m + n) + O(m×n×log(m + n)) = O(m×n×log(m + n))。</p><p>由上可知，将复杂度下降了一个维度。</p><p>建议：对于这种在 BFS 中运用&quot;农村包围城市&quot;的策略，LeetCode 上还有一道题，第 417 题，太平洋大西洋水流问题，建议大家课后去试试。</p><h6 id="结语" tabindex="-1">结语 <a class="header-anchor" href="#结语" aria-label="Permalink to &quot;结语&quot;">​</a></h6><p>这节课讲了三道比较难想的题目，至此已经把所有关于数据结构、算法、以及相关的题目做了讲解，掌握好我们课上讲过的知识点，一定会对你的面试准备有很大的帮助。</p><p>当然，要能在面试中取得理想的发挥，还是要看平时的练习是否足够，不光在数量上，更要在质量上严格要求自己。</p><p>下节课将会分享一些面试准备中的方法和技巧。</p><br>`,189),o=[e];function i(t,r,c,E,b,y){return n(),a("div",null,o)}const m=s(p,[["render",i]]);export{d as __pageData,m as default};
