...
<span class="line"><span style="color:#24292E;">    return a == b || b == &#39;.&#39;;</span></span>
<span class="line"><span style="color:#24292E;"> </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p>注意：</p><ul><li><p>初始化二维矩阵第一行的所有值时，当 s 字符串为空，对于 p 字符串的任何一个位置，要使到这个位置的子串能和空字符串匹配，要求该子串都是由一系列的 &#39;*&#39; 组合构成。</p></li><li><p>对二维矩阵填表，运用到的逻辑跟递归一摸一样。</p></li><li><p>p 的当前字符不是 &#39;*&#39;，判断当前的两个字符是否相等。如果相等，就看 dp[i-1][j-1] 的值，因为它保存了前一个匹配的结果。</p></li><li><p>如果 p 的当前字符是 &#39;*&#39;：</p><ul><li><p>用 &#39;*&#39; 组合表示空字符串，能否匹配，也就是 dp[i][j - 2]；</p></li><li><p>用 &#39;*&#39; 组合表示一个字符，能否匹配，也就是 dp[i - 1][j]。</p></li></ul></li></ul><h3 id="复杂度分析" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h3><p>运用动态规划，把时间复杂度控制在 O(n^2^)，而空间复杂度也是 O(n^2^)。</p><p>建议：LeetCode 上有一道跟这题十分类似的题目，第 44 题，通配符匹配。分析例题的思路，所运用的策略，以及代码的实现，都有很多非常相似的地方。大家一定要去做做看，举一反三才能加深印象。</p><br><br>`,21);function $(H,W,Z,X,ss,as){const a=e("Image");return o(),i("div",null,[r,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie1iAL3rjAFNmGn6rmB8556.gif"}),p(),E,h,y,u,d,g,_,m,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie1mAHiTeAFyyE_vrAho862.gif"}),p(),j,b,A,f,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie1qAJ0yjABmVlo21Z_k078.gif"}),M,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie1uAfvGOAFXqP1fgpyo624.gif"}),p(),q,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie1uAWy3YACOzTjqASVU474.gif"}),s("ol",C,[s("li",null,[s("p",null,[p("在 p 字符串里，a 的下一个字符是 c，不是 '*'，比较 s[i] 和 p[j]。因为它们都是字符 a，所以这个位置匹配正确，i 和 j 同时指向下一个。此时 j 的下一个字符是 '*'，要将 c* 当作一个整体去看待。 "),n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie1uAQkfIAD7sMK4b0q0916.gif"})])]),k]),n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie1yATZ7aACaSPwysGtw610.gif"}),I,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie1yAYdqYACtak4duJdY791.gif"}),v,S,V,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie12AJf14ACHySIotppY330.gif"}),p(),T,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie16AEWe2AGU2311QM54850.gif"}),B,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie1-AAfhyAMUVWpoQPio071.gif"}),P,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie1-AAKtMAGRVK2beFJI055.gif"}),x,F,D,O,N,G,J,w,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie1-AJzGVAACAxM7kNrk693.png"}),p(),Y,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie2CAAZ6aAEk53IJKbK4406.gif"}),K,R,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie2CARkM9AD_zVAmy1eI036.gif"}),z,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie2GALJKxAEMDpEqq9pU613.gif"}),p(),Q,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/FC/CgoB5l2Ie2GAFb2VAAB2VFYCpQA482.png"}),U,n(a,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/1C/CgotOV2Ie2GAA1bPAGMu3IFkH1Y793.gif"}),L])}const ls=t(c,[["render",$]]);export{ps as __pageData,ls as default};
