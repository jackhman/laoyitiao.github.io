import{_ as l,j as o,o as e,g as t,k as p,Q as c,s,h as n}from"./chunks/framework.e0c66c3f.js";const S=JSON.parse('{"title":"副作用渲染函数更新组件的过程 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7627) 02  组件更新：完整的 DOM diff 流程是怎样的？（上）.md","filePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7627) 02  组件更新：完整的 DOM diff 流程是怎样的？（上）.md","lastUpdated":null}'),r={name:"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7627) 02  组件更新：完整的 DOM diff 流程是怎样的？（上）.md"},E=c(`<p>上一节课我们梳理了组件渲染的过程，本质上就是把各种类型的 vnode 渲染成真实 DOM。我们也知道了组件是由模板、组件描述对象和数据构成的，数据的变化会影响组件的变化。组件的渲染过程中创建了一个带副作用的渲染函数，当数据变化的时候就会执行这个渲染函数来触发组件的更新。那么接下来，我们就具体分析一下组件的更新过程。</p><h3 id="副作用渲染函数更新组件的过程" tabindex="-1">副作用渲染函数更新组件的过程 <a class="header-anchor" href="#副作用渲染函数更新组件的过程" aria-label="Permalink to &quot;副作用渲染函数更新组件的过程&quot;">​</a></h3><p>我们先来回顾一下带副作用渲染函数 setupRenderEffect 的实现，但是这次我们要重点关注更新组件部分的逻辑：</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> setupRenderEffect </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) </span><span style="color:#F97583;">=&gt;</span><span style="color:#E1E4E8;"> {</span></span>
