...
<span class="line"><span style="color:#24292E;">version: 2.1.0</span></span></code></pre></div><h3 id="server-对象" tabindex="-1">Server 对象 <a class="header-anchor" href="#server-对象" aria-label="Permalink to &quot;Server 对象&quot;">​</a></h3><p>Server 对象表示 API 的服务器，下表给出了 Server 对象中可以包含的字段及其说明。</p><br>`,7),m=e(`<br><p>下面代码是 Server 对象的使用示例，其中服务器的 URL 中包含了 port 和 basePath 两个参数，port 是枚举类型，可选值是 80 和 8080。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">url: http://test.myapp.com:{port}/{basePath}</span></span>
...
<span class="line"><span style="color:#24292E;">    default: v2</span></span></code></pre></div><h3 id="paths-对象" tabindex="-1">Paths 对象 <a class="header-anchor" href="#paths-对象" aria-label="Permalink to &quot;Paths 对象&quot;">​</a></h3><p>Paths 对象中的字段是动态的。每个字段表示一个路径，以&quot;/&quot;开头，路径可以是包含变量的字符串模板。字段的值是 PathItem 对象，在该对象中可以使用 summary、description、servers 和 parameters 这样的通用字段，还可以使用 HTTP 方法名称，包括 get、put、post、delete、options、head、patch 和 trace，这些方法名称的字段，定义了对应的路径所支持的 HTTP 方法。</p><h3 id="operation-对象" tabindex="-1">Operation 对象 <a class="header-anchor" href="#operation-对象" aria-label="Permalink to &quot;Operation 对象&quot;">​</a></h3><p>在 Paths 对象中，HTTP 方法对应的字段的值的类型是 Operation 对象，表示 HTTP 操作。下表给出了 Operation 对象中可以包含的字段及其说明，在这些字段中，比较常用的是 parameters、requestBody 和 responses。</p><br>`,9),u=n("h3",{id:"parameter-对象",tabindex:"-1"},[s("Parameter 对象 "),n("a",{class:"header-anchor",href:"#parameter-对象","aria-label":'Permalink to "Parameter 对象"'},"​")],-1),P=n("p",null,"Parameter 对象表示操作的参数。下表给出了 Parameter 对象中可以包含的字段及其说明。",-1),A=n("br",null,null,-1),I=e(`<br><p>下面的代码是 Parameter 对象的使用示例，参数 id 出现在路径中，类型是 string。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">name: id</span></span>
...
<span class="line"><span style="color:#24292E;">  type: string</span></span></code></pre></div><h3 id="requestbody-对象" tabindex="-1">RequestBody 对象 <a class="header-anchor" href="#requestbody-对象" aria-label="Permalink to &quot;RequestBody 对象&quot;">​</a></h3><p>RequestBody 对象表示 HTTP 请求的内容，下表给出了 RequestBody 对象中可以包含的字段及其说明。</p><br>`,7),_=n("h3",{id:"responses-对象",tabindex:"-1"},[s("Responses 对象 "),n("a",{class:"header-anchor",href:"#responses-对象","aria-label":'Permalink to "Responses 对象"'},"​")],-1),b=n("p",null,"Responses 对象表示 HTTP 请求的响应，该对象中的字段是动态的。字段的名称是 HTTP 响应的状态码，对应的值的类型是 Response 或 Reference 对象。下表给出了 Response 对象中可以包含的字段及其说明。",-1),v=n("br",null,null,-1),q=e(`<h3 id="reference-对象" tabindex="-1">Reference 对象 <a class="header-anchor" href="#reference-对象" aria-label="Permalink to &quot;Reference 对象&quot;">​</a></h3><p>在对不同类型的对象描述中，字段的类型可以是 Reference 对象，该对象表示对其他组件的引用，其中只包含一个 $ref 字段来声明引用。引用可以是同一文档中的组件，也可以来自外部文件。在文档内部，可以在 Components 对象中定义不同类型的可复用组件，并由 Reference 对象来引用；文档内部的引用是以 # 开头的对象路径，比如 #/components/schemas/CreateTripRequest。</p><h3 id="schema-对象" tabindex="-1">Schema 对象 <a class="header-anchor" href="#schema-对象" aria-label="Permalink to &quot;Schema 对象&quot;">​</a></h3><p>Schema 对象用来描述数据类型的定义，数据类型可以是简单类型、数组或对象类型，通过字段 type 可以指定类型，format 字段表示类型的格式。如果是数组类型，即 type 的值是 array，则需要通过字段 items 来表示数组中元素的类型；如果是对象类型，即 type 的值是 object，则需要通过字段 properties 来表示对象中属性的类型。</p><h3 id="完整文档示例" tabindex="-1">完整文档示例 <a class="header-anchor" href="#完整文档示例" aria-label="Permalink to &quot;完整文档示例&quot;">​</a></h3><p>下面是一个完整的 OpenAPI 文档示例。在 paths 对象中，定义了 3 个操作，操作的请求内容和响应格式的类型定义，都在 Components 对象的 schemas 字段中定义。操作的 requestBody 和 responses 字段都使用 Reference 对象来引用。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">openapi: &#39;3.0.3&#39;</span></span>
...
<span class="line"><span style="color:#24292E;">      required:</span></span>
<span class="line"><span style="color:#24292E;">        - lng</span></span>
<span class="line"><span style="color:#24292E;">        - lat</span></span></code></pre></div><h2 id="openapi-工具" tabindex="-1">OpenAPI 工具 <a class="header-anchor" href="#openapi-工具" aria-label="Permalink to &quot;OpenAPI 工具&quot;">​</a></h2><p>我们可以用一些工具来辅助 OpenAPI 规范相关的开发。作为 OpenAPI 规范的前身，Swagger 提供了很多与 OpenAPI 相关的工具。</p><h3 id="swagger-编辑器" tabindex="-1">Swagger 编辑器 <a class="header-anchor" href="#swagger-编辑器" aria-label="Permalink to &quot;Swagger 编辑器&quot;">​</a></h3><p>Swagger 编辑器是一个 Web 版的 Swagger 和 OpenAPI 文档编辑器。在编辑器的左侧是编辑器，右侧是 API 文档的预览。Swagger 编辑器提供了很多实用功能，包括语法高亮、快速添加不同类型的对象、生成服务器代码和生成客户端代码等。</p><br><p>使用 Swagger 编辑器时，可以直接使用<a href="https://editor.swagger.io/" target="_blank" rel="noreferrer">在线版本</a>，也可以在本地运行，在本地运行最简单的方式是使用 Docker 镜像 swaggerapi/swagger-editor。</p><br><p>下面的代码启动了 Swagger 编辑器的 Docker 容器，容器启动之后，通过 localhost:8000 访问即可。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">docker run -d -p 8000:8080 swaggerapi/swagger-editor</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292E;">docker run -d -p 8000:8080 swaggerapi/swagger-editor</span></span></code></pre></div><br><p>下图是 Swagger 编辑器的界面。</p><br>`,21),T=e('<h3 id="swagger-界面" tabindex="-1">Swagger 界面 <a class="header-anchor" href="#swagger-界面" aria-label="Permalink to &quot;Swagger 界面&quot;">​</a></h3><p>Swagger 界面提供了一种直观的方式来查看 API 文档，并进行交互。通过该界面，可以直接发送 HTTP 请求到 API 服务器，并查看响应结果。</p><br><p>同样，我们可以用 Docker 来启动 Swagger 界面，如下面的命令所示。容器启动之后，通过 localhost:8010 来访问即可。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">docker run -d -p 8010:8080 swaggerapi/swagger-ui</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292E;">docker run -d -p 8010:8080 swaggerapi/swagger-ui</span></span></code></pre></div><br><p>对于本地的 OpenAPI 文档，可以配置 Docker 镜像来使用该文档。假设当前目录中有 OpenAPI 文档 openapi.yml，则可以使用下面的命令来启动 Docker 镜像来展示该文档。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">docker run -p 8010:8080 -e SWAGGER_JSON=/api/openapi.yml -v $PWD:/api swaggerapi/swagger-ui</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292E;">docker run -p 8010:8080 -e SWAGGER_JSON=/api/openapi.yml -v $PWD:/api swaggerapi/swagger-ui</span></span></code></pre></div><br><p>下图是 Swagger 界面的截图。</p><br>',13),f=e(`<h3 id="代码生成" tabindex="-1">代码生成 <a class="header-anchor" href="#代码生成" aria-label="Permalink to &quot;代码生成&quot;">​</a></h3><p>通过 OpenAPI 文档，可以利用 Swagger 提供的代码生成工具来自动生成服务器存根代码和客户端。代码生成时可以使用不同的编程语言和框架。</p><br><p>下面给出了代码生成工具所支持的编程语言和框架。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">aspnetcore, csharp, csharp-dotnet2, go-server, dynamic-html, html, html2, java, jaxrs-cxf-client,</span></span>
...
<span class="line"><span style="color:#24292E;">a-akka-http-server, swift3, swift4, swift5, typescript-angular, javascript</span></span></code></pre></div><br><p>代码生成工具是一个 Java 程序，下载之后可以直接运行。在下载 JAR 文件 <a href="https://repo1.maven.org/maven2/io/swagger/codegen/v3/swagger-codegen-cli/3.0.19/swagger-codegen-cli-3.0.19.jar" target="_blank" rel="noreferrer">swagger-codegen-cli-3.0.19.jar</a> 之后，可以使用下面的命令来生成 Java 客户端代码，其中 -i 参数指定输入的 OpenAPI 文档，-l 指定生成的语言，-o 指定输出目录。</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">java -jar swagger-codegen-cli-3.0.19.jar generate -i openapi.yml -l java -o /tmp</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292E;">java -jar swagger-codegen-cli-3.0.19.jar generate -i openapi.yml -l java -o /tmp</span></span></code></pre></div><br><p>除了生成客户端代码之外，还可以生成服务器存根代码。下面代码是生成 NodeJS 服务器存根代码：</p><br><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">java -jar swagger-codegen-cli-3.0.19.jar generate -i openapi.yml -l nodejs-server -o /tmp</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292E;">java -jar swagger-codegen-cli-3.0.19.jar generate -i openapi.yml -l nodejs-server -o /tmp</span></span></code></pre></div><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>API 优先的策略保证了微服务的 API 在设计时，充分考虑到 API 使用者的需求，使得 API 成为提供者和使用者之间的良好契约。本课时首先介绍了 API 优先的设计策略，然后介绍了 API 的不同实现方式，接着介绍了 REST API 的 OpenAPI 规范，最后介绍了 OpenAPI 的相关工具。</p>`,16);function k(S,O,w,C,j,R){const a=o("Image");return t(),c("div",null,[i,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/03/D7/CgoCgV6ZTAOAe8LCAAAmZRAsEQw388.png"}),s(),E,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/11/06/Ciqah16ZTAOAAwW0AACP-qu5xrk547.png"}),s(),y,d,g,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/8A/1C/Cgq2xl6ZTAOAdpURAABX1Kfh-DM443.png"}),s(),h,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/03/D7/CgoCgV6ZTAOABcF1AAA-57NeBGQ901.png"}),s(),m,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/11/06/Ciqah16ZTAOAC-XoAAC9Yc_U9FY508.png"}),s(),u,P,A,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/8A/1C/Cgq2xl6ZTAOANejbAADhE2FZLo4096.png"}),s(),I,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/03/D7/CgoCgV6ZTAOAU9XxAAA4YbmwX3A208.png"}),s(),_,b,v,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/11/06/Ciqah16ZTAOAHz9LAAB3y1Wy79M022.png"}),s(),q,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/8A/1C/Cgq2xl6ZTASABJOwAAFARz_LfhM630.png"}),s(),T,p(a,{alt:"",src:"https://s0.lgstatic.com/i/image3/M01/03/D7/CgoCgV6ZTASAXGi3AAH17b7200I115.png"}),s(),f])}const D=l(r,[["render",k]]);export{V as __pageData,D as default};
