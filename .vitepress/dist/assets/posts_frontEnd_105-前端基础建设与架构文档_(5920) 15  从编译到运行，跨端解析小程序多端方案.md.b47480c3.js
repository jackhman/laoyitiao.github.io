import{_ as o,j as e,o as t,g as c,k as a,h as p,s,Q as l}from"./chunks/framework.b3d8e22e.js";const L=JSON.parse('{"title":"小程序多端------编译时方案 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/frontEnd/105-前端基础建设与架构文档/(5920) 15  从编译到运行，跨端解析小程序多端方案.md","filePath":"posts/frontEnd/105-前端基础建设与架构文档/(5920) 15  从编译到运行，跨端解析小程序多端方案.md","lastUpdated":1696417798000}'),r={name:"posts/frontEnd/105-前端基础建设与架构文档/(5920) 15  从编译到运行，跨端解析小程序多端方案.md"},E=s("p",null,"客观来说，小程序在用户规模及商业化方面的巨大成功，并不能掩盖其技术环节的设计问题和痛点。从孱弱简陋的小程序开发体验，到整体架构实现，再到小程序 APIs 碎片化现状，就注定了小程序多端方案层出不穷，展现出百家争鸣的局面。",-1),i=s("p",null,"欣欣向荣的小程序多端方案背后有着深广且有趣的技术话题，这一讲，就让我们一同解析小程序多端方案技术。",-1),y=s("p",null,"小程序生态如今已经如火如荼地开展开来，自腾讯微信小程序后，各巨头也纷纷建立起自己的小程序。这些小程序的设计原理类似，但是对于开发者来说，开发层面并不互通。在此背景下，效率为先，也就有了各种小程序多端方案。",-1),d=s("p",null,'小程序多端方案的愿景很简单，就是使用一种 DSL，可以"write once，run evrywhere"，这也就不再需要开发完微信小程序，再开发头条小程序、百度小程序。小程序多端方案也许听起来很神奇，但技术实现上我们可以大体划分为三类：',-1),C=s("ul",null,[s("li",null,[s("p",null,"编译时方案")]),s("li",null,[s("p",null,"运行时方案")]),s("li",null,[s("p",null,"编译时和运行时的结合方案")])],-1),h=l('<p>事实上，单纯的编译时方案或运行时方案都不能完全满足<strong>跨端需求</strong>，因此两者结合而成的第三种------编译时和运行时的结合方案，是目前的主流技术。</p><p>基于以上技术方案，小程序多端方案最终对外提供的使用方式可以分为：</p><ul><li><p>类 Vue 风格框架</p></li><li><p>类 React 风格框架</p></li><li><p>自定义 DSL 框架</p></li></ul><p>下面我们将具体深入小程序多端方案的实现。</p><h3 id="小程序多端-编译时方案" tabindex="-1">小程序多端------编译时方案 <a class="header-anchor" href="#小程序多端-编译时方案" aria-label="Permalink to &quot;小程序多端------编译时方案&quot;">​</a></h3><p>顾名思义，编译时方案的工作量主要集中在<strong>编译转化环节</strong> 上。这类多端框架在编译阶段，<strong>基于 AST（抽象语法树）技术</strong>进行各平台小程序适配。</p><p>目前社区上存在较多基于 Vue DSL 和 React DSL 的静态编译方案。其实现理念类似，但也有区别，我们分开来看。</p><h4 id="vue-dsl-静态编译" tabindex="-1">Vue DSL 静态编译 <a class="header-anchor" href="#vue-dsl-静态编译" aria-label="Permalink to &quot;Vue DSL 静态编译&quot;">​</a></h4><p>Vue 的设计风格和各小程序设计风格更加接近，因此 Vue DSL 静态编译方案相对容易。Vue 中单文件组件主要由：</p><ul><li><p>template</p></li><li><p>script</p></li><li><p>style</p></li></ul><p>组成，它分别对应了小程序中的：</p><ul><li><p>.wxml 文件，template 文件</p></li><li><p>.js 文件，.json 文件</p></li><li><p>.wxss 文件</p></li></ul>',12),g=s("p",null,[p("其中，因为小程序基本都可以接受 H5 环境中的 CSS，因此"),s("strong",null,"style 部分基本可以直接平滑迁移"),p("。template 转换为 .wxml 文件，需要进行 HTML 标签、模版语法的转换。以微信小程序举例，转换目标如下图：")],-1),u=s("p",null,"编译过程图",-1),F=s("p",null,"那么上图表述的编译过程具体应该如何实现呢？可能你会想到正则，但正则的能力有限，复杂度也较高。更普遍的做法，如 mpvue、uni-app 等，都依赖了 AST（抽象语法树）技术。AST（抽象语法树）其实并不复杂，Babel 生态就为我们提供了很多开箱即用的 AST 分析和操作工具。下图是一个简单的 Vue 模版经过 AST 分析后的产出：",-1),A=l(`<p>对应模版代码：</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">&lt;</span><span style="color:#E1E4E8;">a</span><span style="color:#F97583;">&gt;&lt;</span><span style="color:#E1E4E8;">b v</span><span style="color:#F97583;">-if=</span><span style="color:#9ECBFF;">&quot;a&quot;</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">/&gt;&lt;/</span><span style="color:#E1E4E8;">a</span><span style="color:#F97583;">&gt;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#D73A49;">&lt;</span><span style="color:#24292E;">a</span><span style="color:#D73A49;">&gt;&lt;</span><span style="color:#24292E;">b v</span><span style="color:#D73A49;">-if=</span><span style="color:#032F62;">&quot;a&quot;</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">/&gt;&lt;/</span><span style="color:#24292E;">a</span><span style="color:#D73A49;">&gt;</span></span></code></pre></div><p>经过 AST 解析为：</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">type</span><span style="color:#F97583;">:</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">1</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p>整体 Taro Next 的类 React 多端方案架构如图，出自《小程序跨框架开发的探索与实践》分享：</p>`,9),R=l('<p>了解了不同框架风格（Vue 和 React）的多端小程序技术架构方案，并不意味着我们就能直接写出一个新的框架，和社区上成熟方案相争锋指日可待了。一个成熟的技术方案除了实现主体架构，还包括多方面的内容，比如性能优化。</p><p>如何在已有思路基础上，完成更好的设计，也值得开发者深思，我们将继续展开这个话题。</p><h3 id="小程序多端方案优化方向" tabindex="-1">小程序多端方案优化方向 <a class="header-anchor" href="#小程序多端方案优化方向" aria-label="Permalink to &quot;小程序多端方案优化方向&quot;">​</a></h3><p>一个成熟的小程序多端方案要考虑的环节是立体的，比如以 <a href="https://developers.weixin.qq.com/miniprogram/dev/extended/kbone/" target="_blank" rel="noreferrer">kbone</a> 为代表，运行时方案都是通过模拟 Web 环境来彻底对接前端生态，而 Remax 只是简单的通过 react reconciler 连接 React 和小程序。如何从更高的角度，衡量和理解小程序多端方案的更多技术方向，我们从下面几个话题来继续阐述。</p><h4 id="性能优化方向" tabindex="-1">性能优化方向 <a class="header-anchor" href="#性能优化方向" aria-label="Permalink to &quot;性能优化方向&quot;">​</a></h4><p>从前文我们可以了解到，小程序多端框架主要由编译时和运行时两部分组成，一般来说，<strong>编译时做的事情越多，下的功夫越大，也就意味着运行时越轻量，负担越小，因此性能也就会更好</strong>。比如，我们可以在编译时做到 AOT（Ahead of Time）性能调优、Dead Code Elimination 等。而厚重的运行时一般意味着需要将完整的组件树在逻辑层传输到视图层，也就导致数据传输量更大，且页面中会存在更多的监听器。</p><p>另一方面，随着终端性能的增强，找到编译时和运行时所承担工作的平衡点，也显得至关重要。以 mpvue 框架为主，一般编译时都会完成<strong>静态模版</strong> 的编译工作；而以 Remax 为代表，<strong>动态构建视图层表达就放在了运行时完成</strong>。</p><p>在我看来，关于运行时和编译时的各中取舍，需要基于大量 benchmark 调研，也需要开发设计者广阔的技术视野和选型能力。除此之外，一般我们可以从以下几个方面来进一步实现性能优化。</p><ul><li><p><strong>框架包 size</strong>。小程序的初始加载性能直接依赖于资源的包大小，因此小程序多端框架的包 size，至关重要。为此，各解决方案都从不同的角度完成瘦身，比如 Taro 力争实现更轻量的 DOM/BOM APIs，不同于 jsdom（size：2.1M），Taro 的核心的 DOM/BOM APIs 代码才 1000 行不到。</p></li><li><p><strong>数据更新粒度</strong>。在数据更新阶段，小程序的 setData() 所负载的数据一直是重要的优化方向，目前已经成为默认的常规手段，那么利用框架来完成 setData() 方法调用优化也就顺其自然了。比如数据负载的扁平化处理和增量处理，都是常见的优化手段。</p></li></ul><h4 id="未来发展方向" tabindex="-1">未来发展方向 <a class="header-anchor" href="#未来发展方向" aria-label="Permalink to &quot;未来发展方向&quot;">​</a></h4><p>好的技术架构决定着未来发展潜力，上文我们提到了 React 将 React core、React-dom 等解耦，才奠定了现代化小程序多端方案的可行性。而小程序多端方案的设计，也决定着自身的未来应用空间。在此层面上，我认为开发者可重点考虑以下几个方面。</p><ul><li><p><strong>工程化方案</strong> 。小程序多端需要有一体化的工程解决方案，在设计上可以与 Webpack 等工程化工具深度融合绑定，并对外提供服务。但需要<strong>兼顾关键环节的可插拔性</strong>，能够适应多种工程化工具，对于未来发展和当下应用场景来说，尤其重要。</p></li><li><p><strong>框架方案</strong> 。React 和 Vue 无疑是当前最重要的前端框架，目前小程序多端方案也都以二者为主。但是<strong>Flutter 和 Angular，甚至更小众的框架也应该得到重视</strong>。考虑到投入产出比，如果小程序多端团队难以面面俱到地支持这些框架和新 DSL，那么交给社区寻求支持，也是一个思路。比如，Taro 团队将支持的重点放在 React/Vue，而快应用以及 Flutter 和 Angular，暂且交给社区来适配和维护。</p></li><li><p><strong>跟进 Web 发展</strong> 。在运行时，小程序多端方案一般需要在小程序逻辑层中运行 React 或者是 Vue 的运行时版，然后通过适配层，实现自定义渲染器。这就要求设计开发者需要<strong>跟进 Web 发展及 Web 框架的运行时能力，且实现适配层</strong>。这无疑对技术能力和水平提出了较高要求。如何处理 Web 和 Web 框架的关系、如何保持兼容互通，决定了小程序多端方案的生死。</p></li><li><p><strong>渐进增强型能力</strong> 。无论是和 Web 兼容互通还是多种小程序之间的差异磨平，对于多端方案来说，很难从理论上彻底实现&quot;write once，run evrywhere&quot;。因此，这就需<strong>要框架级别上实现一套渐进增强能力</strong> 。这种能力，可以是语法或 DSL 层面的暂时性妥协/便利性扩展，也可以通过暴露全局变量，进行不同环境的业务分发。比如<strong>腾讯开源的</strong> <a href="https://github.com/Tencent/omi/tree/master/packages/omix" target="_blank" rel="noreferrer">OMIX</a> <strong>框架</strong>：OMIX 有自己的一套 DSL，但整体保留小程序已有的语法。在小程序已有语法之上，OMIX 还进行了扩充和增强，比如引入了 Vue 中比较有代表性的 computed。</p></li></ul><h3 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h3><p>这一讲我们针对小程序多端方案进行了原理层面的分析，同时站在更高的视角，对不同方案和多端框架进行了比对和技术展望。实际上，理解全部内容需要你对 React 和 Vue 框架原理有更深入的了解，也需要对编译原理和宿主环境（小程序底层实现架构）有清晰的认知。</p><p>本讲内容如下：</p>',15),k=s("p",null,"从小程序发展元年开始，到 2018 微信小程序的起飞，再到后续各大厂商快速跟进、各大寡头平台自建小程序生态，小程序现象带给我们的不仅仅是业务价值方面的讨论和启迪，也应该是对相关技术架构的巡礼和探索。作为开发者，我认为对技术的深度挖掘和运用，是能够始终矗立在时代风口浪尖的重要根基。",-1),S=s("p",null,"下一讲，我将带你分析 Flutter 和原生跨平台技术栈，同时梳理当下相关技术热点。跨平台其实是一个老生常谈的话题，技术方案也是历经变迁，但始终热点不断。下一讲的内容和今天的内容也有着千丝万缕的联系，别走开，我们下一讲再见！",-1);function N(V,w,M,q,O,j){const n=e("Image");return t(),c("div",null,[E,i,y,d,C,a(n,{alt:"Drawing 0.png",src:"https://s0.lgstatic.com/i/image/M00/91/75/Ciqc1GAOlPOADUxDAACGGDiNvBo264.png"}),h,a(n,{alt:"Lark20210129-191128.png",src:"https://s0.lgstatic.com/i/image/M00/93/2E/CgqCHmAT7b2AYQJdAADnHNucgjE454.png"}),g,a(n,{alt:"Lark20210129-191131.png",src:"https://s0.lgstatic.com/i/image/M00/93/23/Ciqc1GAT7auABbA4AAD1EDPUmAQ243.png"}),p(),u,F,a(n,{alt:"Drawing 3.png",src:"https://s0.lgstatic.com/i/image/M00/91/75/Ciqc1GAOlROAPr2kAAK2OejCvBU840.png"}),A,a(n,{alt:"Lark20210129-191134.png",src:"https://s0.lgstatic.com/i/image/M00/93/2E/CgqCHmAT7ceAKd6fAACYXlFC1nQ021.png"}),f,a(n,{alt:"Lark20210129-191136.png",src:"https://s0.lgstatic.com/i/image/M00/93/2E/CgqCHmAT7dKAGSVzAAEawS6G6xY828.png"}),D,m,_,T,H,a(n,{alt:"图片2.png",src:"https://s0.lgstatic.com/i/image/M00/94/37/CgqCHmAXmvKAEQr9AAErNUu9oi4120.png"}),p(),b,a(n,{alt:"Drawing 7.png",src:"https://s0.lgstatic.com/i/image2/M01/09/65/Cip5yGAOlUeAEB4oAAO9Arzu18g785.png"}),B,a(n,{alt:"Lark20210129-191112.png",src:"https://s0.lgstatic.com/i/image/M00/93/2E/CgqCHmAT7hyAENc8AAFoe_ttcg4719.png"}),v,a(n,{alt:"Drawing 9.png",src:"https://s0.lgstatic.com/i/image/M00/91/75/Ciqc1GAOlWyAV2OnAADz2iM_2mM698.png"}),I,a(n,{alt:"Lark20210129-192321.png",src:"https://s0.lgstatic.com/i/image/M00/93/2E/CgqCHmAT8DSAGRn-AAJEN4yKmdI464.png"}),x,a(n,{alt:"Lark20210129-192324.png",src:"https://s0.lgstatic.com/i/image/M00/93/23/Ciqc1GAT8D6ADrYMAAICYbpPasw785.png"}),P,a(n,{alt:"图片3.png",src:"https://s0.lgstatic.com/i/image/M00/94/2C/Ciqc1GAXmzmACf4fAAVidO1Nf0U984.png"}),R,a(n,{alt:"Drawing 13.png",src:"https://s0.lgstatic.com/i/image/M00/91/80/CgqCHmAOlbyATtP1AAHVogfDtTQ350.png"}),k,S])}const z=o(r,[["render",N]]);export{L as __pageData,z as default};
