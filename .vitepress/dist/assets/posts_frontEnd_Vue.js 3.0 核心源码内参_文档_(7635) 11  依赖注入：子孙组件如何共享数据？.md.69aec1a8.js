import{_ as p,j as o,o as e,g as t,k as a,h as l,Q as s}from"./chunks/framework.4e7d56ce.js";const A=JSON.parse('{"title":"11依赖注入：子孙组件如何共享数据？","description":"","frontmatter":{},"headers":[],"relativePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7635) 11  依赖注入：子孙组件如何共享数据？.md","filePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7635) 11  依赖注入：子孙组件如何共享数据？.md","lastUpdated":1696417798000}'),c={name:"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7635) 11  依赖注入：子孙组件如何共享数据？.md"},r=s(`<h1 id="_11依赖注入-子孙组件如何共享数据" tabindex="-1">11依赖注入：子孙组件如何共享数据？ <a class="header-anchor" href="#_11依赖注入-子孙组件如何共享数据" aria-label="Permalink to &quot;11依赖注入：子孙组件如何共享数据？&quot;">​</a></h1><p>Vue.js 为我们提供了很多组件通讯的方式，常见的是父子组件通过 prop 传递数据。但是有时，我们希望能<strong>跨父子组件通讯</strong>，比如，无论组件之间嵌套多少层级，我都希望在后代组件中能访问它们祖先组件的数据。</p><p>Vue.js 2.x 给我们提供了一种依赖注入的解决方案，即在祖先组件提供一个 provide 选项，举个例子：</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// Provider </span></span>
...
<span class="line"><span style="color:#24292E;">    } </span></span>
<span class="line"><span style="color:#24292E;">  } </span></span>
<span class="line"><span style="color:#B31D28;font-style:italic;">&lt;/script&gt;</span></span></code></pre></div><p>这是 Select 组件的基础示例，它最终会在页面上渲染成这样：</p>`,35),y=s(`<p>子组件 ElOption 负责渲染每一个选项，它的内部想要访问最外层的 ElSelect 组件时，就可以通过依赖注入的方式，在 ElSelect 组件中提供组件的实例：</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">export </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> { </span></span>
...
<span class="line"><span style="color:#24292E;">    } </span></span>
<span class="line"><span style="color:#24292E;">  } </span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><p>我们可以清楚地分辨出模板中使用的 x、y 是来源于 useMousePosition 函数，即便我们引入更多的 hook 函数，也不会出现命名冲突的情况。</p><p>Composition API 在逻辑复用上确实有不错的优势，但是它并非完美的，使用起来会增加代码量。Composition API 属于 API 的增强，它并不是 Vue.js 3.0 组件开发的范式，如果你的组件足够简单，还是可 以使用 Options API 的。</p><p>最后，给你留一道思考题目，如果你想利用依赖注入让整个应用下组件都能共享某个数据，你会怎么做？为什么？欢迎你在留言区与我分享。</p><blockquote><p><strong>本节课的相关代码在源代码中的位置如下：</strong></p><p>packages/runtime-core/src/apiInject.ts</p></blockquote>`,18);function d(u,v,F,g,h,f){const n=o("Image");return e(),t("div",null,[r,a(n,{alt:"4.png",src:"https://s0.lgstatic.com/i/image/M00/42/E3/CgqCHl86T3KAQuhfAACt-IfYuPc049.png"}),l(),E,a(n,{alt:"select1.png",src:"https://s0.lgstatic.com/i/image/M00/42/D8/Ciqc1F86T9CAGMkuAACL3WKe6QA403.png"}),l(),y,a(n,{alt:"select2.png",src:"https://s0.lgstatic.com/i/image/M00/42/E3/CgqCHl86T-OAVgk-AACFqLBanFk012.png"}),l(),i])}const m=p(c,[["render",d]]);export{A as __pageData,m as default};
