import{_ as l,j as o,o as e,g as t,k as a,Q as p,s}from"./chunks/framework.e0c66c3f.js";const h=JSON.parse('{"title":"创建和设置组件实例 ","description":"","frontmatter":{},"headers":[],"relativePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7630) 04  Setup：组件渲染前的初始化过程是怎样的？.md","filePath":"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7630) 04  Setup：组件渲染前的初始化过程是怎样的？.md","lastUpdated":null}'),c={name:"posts/frontEnd/Vue.js 3.0 核心源码内参_文档/(7630) 04  Setup：组件渲染前的初始化过程是怎样的？.md"},r=p(`<p>Vue.js 3.0 允许我们在编写组件的时候添加一个 setup 启动函数，它是 Composition API 逻辑组织的入口，本节课我们就来分析一下这个函数。</p><p>我们先通过一段代码认识它，在这里编写一个 button 组件：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
