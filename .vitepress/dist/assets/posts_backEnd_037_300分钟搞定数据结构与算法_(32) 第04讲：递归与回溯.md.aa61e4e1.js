...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h6 id="例题分析二" tabindex="-1">例题分析二 <a class="header-anchor" href="#例题分析二" aria-label="Permalink to &quot;例题分析二&quot;">​</a></h6><p>LeetCode 第 247 题：找到所有长度为 n 的中心对称数。</p><p><strong>示例</strong></p><p>输入: n = 2</p><p>输出: [&quot;11&quot;,&quot;69&quot;,&quot;88&quot;,&quot;96&quot;]</p><h3 id="解题思路-1" tabindex="-1">解题思路 <a class="header-anchor" href="#解题思路-1" aria-label="Permalink to &quot;解题思路&quot;">​</a></h3>`,34),E=s(`<ul><li><p>当 n=0 的时候，应该输出空字符串：&quot; &quot;。</p></li><li><p>当 n=1 的时候，也就是长度为 1 的中心对称数有：0，1，8。</p></li><li><p>当 n=2 的时候，长度为 2 的中心对称数有：11， 69，88，96。注意：00 并不是一个合法的结果。</p></li><li><p>当 n=3 的时候，只需要在长度为 1 的合法中心对称数的基础上，不断地在两边添加 11，69，88，96 就可以了。</p></li></ul><p>[101, 609, 808, 906, 111, 619, 818, 916, 181, 689, 888, 986]</p><br><p>随着 n 不断地增长，我们只需要在长度为 n-2 的中心对称数两边添加 11，69，88，96 即可。</p><h2 id="代码实现-1" tabindex="-1">代码实现 <a class="header-anchor" href="#代码实现-1" aria-label="Permalink to &quot;代码实现&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">List&lt;</span><span style="color:#FDAEB7;font-style:italic;">String</span><span style="color:#E1E4E8;">&gt; helper(int n, int m) {</span></span>
<span class="line"><span style="color:#E1E4E8;">    // 第一步：判断输入或者状态是否非法？</span></span>
