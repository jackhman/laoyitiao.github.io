...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><br><p>为什么贪婪算法能在这里成立？</p><p>每当遇到一个新的会议时，总是贪婪地从所有会议室里找出最先结束会议的那个。</p><p>为什么这样可以产生最优的结果？</p><p>若选择的会议室中会议未结束，则意味着需要开辟一个新会议室，这已经不是当前的最优解了</p><br><p><strong>建议</strong> ：贪婪算法考点在面试中相对于其他算法而言是比较轻的，大家只需要把常见的一些利用贪婪算法解题的题目多加练习即可。</p><h6 id="结语" tabindex="-1">结语 <a class="header-anchor" href="#结语" aria-label="Permalink to &quot;结语&quot;">​</a></h6><p>这节课讲解了二分搜索算法和贪婪算法。其中，二分搜索算法是重中之重，因为它看似简单，但要写对却不那么容易。</p><p>建议：LeetCode 上对二分搜索算法和贪婪算法的相关题目都做了很好的筛选，大家要多加练习。</p><p>从下节课开始，我们将运用之前学到的数据结构和算法知识来解决一些高频算法面试题以及难题。</p><br>`,65);function m(u,f,b,w,v,_){const s=p("Image");return e(),t("div",null,[c,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/2E/CgoB5l2Im2uAakC4AJXD2o1RZv4579.gif"}),o(),E,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/2E/CgoB5l2Im3GAdPWdANoBwqIsGSM491.gif"}),d,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/4E/CgotOV2Im3WAelpCAFuvvFr9ZL8086.gif"}),y,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/4E/CgotOV2Im3iANsA9AE-IXo7x7Ns309.gif"}),h,n(s,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/4E/CgotOV2Im3mAMogQACRtykBbh7Q848.gif"}),g])}const A=l(r,[["render",m]]);export{k as __pageData,A as default};
