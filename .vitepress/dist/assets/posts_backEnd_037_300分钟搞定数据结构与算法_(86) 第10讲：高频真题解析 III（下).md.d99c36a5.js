...
<span class="line"><span style="color:#24292E;">  </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h3 id="复杂度分析-3" tabindex="-1">复杂度分析 <a class="header-anchor" href="#复杂度分析-3" aria-label="Permalink to &quot;复杂度分析&quot;">​</a></h3><p>时间复杂度为 O(n) ，这是一种比较高效的做法。</p><h3 id="举例说明" tabindex="-1">举例说明 <a class="header-anchor" href="#举例说明" aria-label="Permalink to &quot;举例说明&quot;">​</a></h3><p>下面通过举例来加深印象。</p><p>例题：needle 是 ADCADBADCADC。</p>`,8),Z=s("ol",null,[s("li",null,"一开始，初始化 LPS 数组全部为 0。")],-1),H=s("p",null,"规定前缀和后缀不能是同一个字符串，所以从第二个字符开始扫描，此时 len = 0，i = 1。AD 字符串的最长公共前缀和后缀为 0，因为 A 不等于 D，所以 LPS[1] = 0。",-1),U=s("ol",{start:"2"},[s("li",null,"移动到 C。同样，对于 ADC ，最长的公共前缀和后缀也是 0，所以 LPS[2] = 0，此时，len 变量一直是 0。")],-1),X=s("ol",{start:"3"},[s("li",null,"移动到 A，此时 i=3。")],-1),z=s("p",null,"对于字符串 ADCA，因为 needle[len] = needle[3]，所以执行代码 lps[i++] = ++len，也就是把 len+1 赋给 lps[i]，然后 i + 1，len + 1，表明对于字符串 ADCA，最长的公共前缀和后缀的长度为 1。",-1),$=s("ol",{start:"4"},[s("li",null,"接下来到 D，此时 i = 4，len = 1。")],-1),ss=s("p",null,"同样，由于 needle[len] 等于 needle[i]，都是字符 D，所以再次执行代码 lps[i++] = ++len，这样一来，lps[4] 就等于 2，表明对于字符串 ADCAD，最长的公共前缀和后缀长度是 2。",-1),ns=s("ol",{start:"5"},[s("li",null,"接下来是 B，此时 i = 5，len = 2。")],-1),as=s("p",null,"needle[len] ='C'，而 needle[i] ='B'，两者不相等，同时，len 大于 0，将 len 修改为 lps[len - 1]，取出字符串 AD 的最长公共前缀和后缀的长度，也就是 0。当循环再次进行，needle[len] 仍不等于 neele[i]，因此对于 ADCADB ，最长的公共前缀后缀长度为 0。",-1),ls=s("p",null,[s("strong",null,"建议"),l("：以上基本概括了 KMP 的算法思想和精髓，其实 KMP 的代码实现是很精妙的，建议大家不要去死记硬背，通过理解去帮助记忆。")],-1),ps=s("h6",{id:"结语",tabindex:"-1"},[l("结语 "),s("a",{class:"header-anchor",href:"#结语","aria-label":'Permalink to "结语"'},"​")],-1),es=s("p",null,"这节课讲解了三道比较难的题目，其中正规表达式以及 KMP 算法是重中之重。",-1),ts=s("br",null,null,-1);function os(is,cs,rs,Es,hs,ys){const n=t("Image");return o(),i("div",null,[r,E,h,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaBmANhiBAAAvRVLSdAM365.png"}),y,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaBqAT7fLAHGVT_G-HGE157.gif"}),d,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaBqAXPBJAA5Vx5kRvrI712.gif"}),g,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaBuAQ_G7AB8iyyFhsP8537.gif"}),_,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaBuAanh5ABOPEuDQKbE900.gif"}),u,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaByAHgaZABWZDxwJlTo840.gif"}),A,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaByAQjMCAByIrvLjjAM248.gif"}),m,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaByAfZyzAABI-qF4lwQ735.png"}),k,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB2ACxD_AC1iHvcGTv8971.gif"}),C,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaB2AS6txACaMXIPm9-I299.gif"}),B,f,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB6AZDoqAB3_QEbtXrY350.gif"}),l(),P,S,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaB6AWUQNACIE9DZQPyI414.gif"}),l(),b,q,I,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB6AMiybAByyazYRVgg510.gif"}),l(),D,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaB-AZrqFAIWMuevJfbs428.gif"}),l(),T,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCCAEy-TABNB_IdI3Eg442.gif"}),M,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCCAJ39aAERYoGxb1p0088.gif"}),l(),x,j,L,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCGAZUF4AAAhUwmoEAc094.png"}),V,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCGAJrCpAAAk60Qcsyw360.png"}),l(),v,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCGACDXcAB5wm3NTrb4729.gif"}),l(),O,w,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCKAeEE4AI6KeO453eY927.gif"}),l(),N,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCOAJzQ0ACMA3QOrN2A725.gif"}),K,Q,F,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCOAcfWEAHw9WU7AYQY830.gif"}),R,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCSATVZPACdhTz792dg446.gif"}),l(),G,J,Y,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCSAVpIQAFEf-VyP6-A314.gif"}),W,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCWAYemSAGbI_2HuWFE739.gif"}),Z,H,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCaATxS8ABYXnYXhN1Y816.gif"}),U,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCaAEnHyACFGv5D5WL4879.gif"}),X,z,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/91/04/CgotOV2IaCaAPe83ACKGclsUKCA865.gif"}),$,ss,a(n,{alt:"",src:"http://s0.lgstatic.com/i/image2/M01/90/E4/CgoB5l2IaCeAW6P4AEhZHBJ_UJQ849.gif"}),ns,as,ls,ps,es,ts])}const _s=e(c,[["render",os]]);export{gs as __pageData,_s as default};
