...
![并发1.png](https://s0.lgstatic.com/i/image3/M01/16/C4/Ciqah16mdUSAMRBKAAMgEaW4ZPQ663.png)
...
![并发2.png](https://s0.lgstatic.com/i/image3/M01/09/99/CgoCgV6meLSAIJhqAAFbtx6oz1U847.png)

而单面往往是流水线形式的、一对一的面试。假设我们一共有 5 个面试官进行单面，即这 5 个面试官同时分别面试一个候选人，在面试过程中，候选人会进行排队，前面的候选人面试完了以后，后面候选人就跟上，找空闲的面试官开始面试，这就是单面的场景。

![并发3.png](https://s0.lgstatic.com/i/image3/M01/16/C8/Ciqah16meL6AWGzVAAEpniT-r2k348.png)
